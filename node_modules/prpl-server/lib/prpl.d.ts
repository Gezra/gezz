 ...
 */
export declare function makeHandler(root?: string, config?: Config): (request: http.IncomingMessage, response: http.ServerResponse, next?: express.NextFunction) => void;
