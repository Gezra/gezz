...
const argDefs = [
    ...
    },
    {
        name: 'config',
        type: String,
        description: 'JSON configuration file (default "<root>/polymer.json" if exists).',
    },
    {
        name: 'https-redirect',
        type: Boolean,
        description: 'Redirect HTTP requests to HTTPS with a 301. Assumes same hostname ' +
    ...
    },
    {
        name: 'cache-control',
        type: String,
        description: 'The Cache-Control header to send for all requests except the ' +
