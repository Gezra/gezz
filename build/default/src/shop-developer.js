define(["../node_modules/@polymer/polymer/polymer-element.js", "../node_modules/@polymer/paper-dialog/paper-dialog.js", "../node_modules/@google-pay/button-element/dist/index.js", "./shop-common-styles.js", "./shop-configuration.js"], function (_polymerElement, _paperDialog, _index, _shopCommonStyles, _shopConfiguration) {
  "use strict";
  ...
  function filterPaymentRequest(paymentRequest) {
    const {
      callbackIntents
          ...
          request = babelHelpers.objectWithoutProperties(paymentRequest, ["callbackIntents"]);
    return request;
  }
  ...
  class ShopDeveloper extends _polymerElement.PolymerElement {
    static get template() {
