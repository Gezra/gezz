define(["../node_modules/@polymer/polymer/polymer-element.js", "../node_modules/@polymer/polymer/lib/legacy/polymer.dom.js", "../node_modules/@polymer/polymer/lib/utils/async.js"], function (_polymerElement, _polymerDom, _async) {
  "use strict";

  class ShopTabsOverlay extends _polymerElement.PolymerElement {
    static get template() {
    ...
    _move(oldTarget, newTarget) {
      ...
      if (toRect.top === 0 && toRect.right === 0 && toRect.bottom === 0 && toRect.left === 0 && toRect.width === 0 && toRect.height === 0) {
        ...
        _async.microTask.run(this._moveComplete.bind(this));
