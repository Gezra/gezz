define(["../node_modules/@polymer/polymer/polymer-element.js", "../node_modules/@polymer/polymer/lib/utils/debounce.js", "../node_modules/@polymer/polymer/lib/utils/async.js"], function (_polymerElement, _debounce, _async) {
  "use strict";
  ...
  class ShopCategoryData extends _polymerElement.PolymerElement {
    static get is() {
    ...
    _getResource(rq, attempts) {
      ...
      xhr.addEventListener('error', e => {
        ...
        if (attempts > 1) {
          this._getResourceDebouncer = _debounce.Debouncer.debounce(this._getResourceDebouncer, _async.timeOut.after(200), this._getResource.bind(this, rq, attempts - 1));
        } else {
