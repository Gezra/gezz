define(["../node_assets/@polymer/polymer/polymer-element.js", "../node_assets/@google-pay/button-element/dist/index.js", "./shop-button.js", "./shop-common-styles.js", "./shop-disclaimer.js", "./shop-form-styles.js", "./shop-configuration.js"], function (_polymerElement, _index, _shopButton, _shopCommonStyles, _shopDisclaimer, _shopFormStyles, _shopConfiguration) {
  "use strict";

  const googlepayConfig = (0, _shopConfiguration.getGooglePayConfig)();

  class ShopCart extends _polymerElement.PolymerElement {
    static get template() {
    ...
    static get observers() {
      return ['_refreshDetails(cart, total)'];
    }
