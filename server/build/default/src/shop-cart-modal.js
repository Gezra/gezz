define(["../node_assets/@polymer/polymer/polymer-element.js", "../node_assets/@polymer/iron-flex-layout/iron-flex-layout.js", "../node_assets/@polymer/paper-icon-button/paper-icon-button.js", "../node_assets/@polymer/iron-overlay-behavior/iron-overlay-behavior.js", "./shop-button.js", "../node_assets/@polymer/polymer/lib/legacy/class.js"], function (_polymerElement, _ironFlexLayout, _paperIconButton, _ironOverlayBehavior, _shopButton, _class) {
  "use strict";

  class ShopCartModal extends (0, _class.mixinBehaviors)([_ironOverlayBehavior.IronOverlayBehaviorImpl], _polymerElement.PolymerElement) {
    static get template() {
