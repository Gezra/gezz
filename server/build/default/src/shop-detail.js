define(["../node_assets/@polymer/polymer/polymer-element.js", "../node_assets/@polymer/app-route/app-route.js", "../node_assets/@polymer/iron-flex-layout/iron-flex-layout.js", "../node_assets/@google-pay/button-element/dist/index.js", "./shop-button.js", "./shop-category-data.js", "./shop-common-styles.js", "./shop-disclaimer.js", "./shop-image.js", "./shop-select.js", "../node_assets/@polymer/polymer/lib/utils/debounce.js", "../node_assets/@polymer/polymer/lib/utils/async.js", "./shop-configuration.js"], function (_polymerElement, _appRoute, _ironFlexLayout, _index, _shopButton, _shopCategoryData, _shopCommonStyles, _shopDisclaimer, _shopImage, _shopSelect, _debounce, _async, _shopConfiguration) {
  "use strict";

  const googlepayConfig = (0, _shopConfiguration.getGooglePayConfig)();

  class ShopDetail extends _polymerElement.PolymerElement {
    static get template() {
    ...
    _itemChanged(item, visible) {
      if (visible) {
        this._itemChangeDebouncer = _debounce.Debouncer.debounce(this._itemChangeDebouncer, _async.microTask, () => {
