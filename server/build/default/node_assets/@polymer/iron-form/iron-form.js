define(["../polymer/polymer-legacy.js", "../iron-ajax/iron-ajax.js", "../polymer/lib/legacy/polymer-fn.js", "../polymer/lib/legacy/polymer.dom.js", "../polymer/lib/utils/html-tag.js"], function (_polymerLegacy, _ironAjax, _polymerFn, _polymerDom, _htmlTag) {
  "use strict";
...
`,
    ...
    attached: function () {
      ...
      this._form = (0, _polymerDom.dom)(this).querySelector('form');
      ...
      if (this._form) {
        ...
        this._nodeObserver = (0, _polymerDom.dom)(this).observeNodes(function (mutations) {
          for (var i = 0; i < mutations.addedNodes.length; i++) {
            if (mutations.addedNodes[i].tagName === 'FORM') {
              ...
              (0, _polymerDom.dom)(this).unobserveNodes(this._nodeObserver);
    ...
    _findElements: function (parent, ignoreName, skipSlots, submittable) {
      ...
      var nodes = (0, _polymerDom.dom)(parent).querySelectorAll('*');
    ...
    _searchSubmittableInSlot: function (submittable, node, ignoreName) {
      var assignedNodes = (0, _polymerDom.dom)(node).getDistributedNodes();
      ...
      for (var i = 0; i < assignedNodes.length; i++) {
        ...
        var nestedAssignedNodes = (0, _polymerDom.dom)(assignedNodes[i]).querySelectorAll('*');
