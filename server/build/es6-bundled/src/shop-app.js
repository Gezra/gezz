...
notifyPropertyChanged(property){return this.initializeButton()}}_exports.$indexDefault=GooglePayButton;GooglePayButton._observedAttributes=[];__decorate([Notify(),Alias("paymentrequest")],GooglePayButton.prototype,"paymentRequest",void 0);__decorate([NotifyAttribute()],GooglePayButton.prototype,"environment",void 0);__decorate([NotifyBooleanAttribute(),Alias("existingpaymentmethodrequired")],GooglePayButton.prototype,"existingPaymentMethodRequired",void 0);__decorate([NotifyAttribute(),Alias("buttoncolor")],GooglePayButton.prototype,"buttonColor",void 0);__decorate([NotifyAttribute(),Alias("buttontype")],GooglePayButton.prototype,"buttonType",void 0);__decorate([NotifyAttribute(),Alias("buttonsizemode")],GooglePayButton.prototype,"buttonSizeMode",void 0);__decorate([NotifyAttribute(),Alias("buttonlocale")],GooglePayButton.prototype,"buttonLocale",void 0);__decorate([Notify(),Alias("paymentDataChangedCallback"),Alias("paymentdatachangedcallback"),Alias("onpaymentdatachanged")],GooglePayButton.prototype,"onPaymentDataChanged",void 0);__decorate([Notify(),Alias("paymentAuthorizedCallback"),Alias("paymentauthorizedcallback"),Alias("onpaymentauthorized")],GooglePayButton.prototype,"onPaymentAuthorized",void 0);__decorate([Alias("readyToPayChangeCallback"),Alias("readytopaychangecallback"),Alias("onreadytopaychange")],GooglePayButton.prototype,"onReadyToPayChange",void 0);__decorate([Alias("loadPaymentDataCallback"),Alias("loadpaymentdatacallback"),Alias("onloadpaymentdata")],GooglePayButton.prototype,"onLoadPaymentData",void 0);__decorate([Alias("cancelCallback"),Alias("cancelcallback"),Alias("oncancel")],GooglePayButton.prototype,"onCancel",void 0);__decorate([Alias("errorCallback"),Alias("errorcallback"),Alias("onerror")],GooglePayButton.prototype,"onError",void 0);__decorate([Alias("clickCallback"),Alias("clickcallback"),Alias("onclick")],GooglePayButton.prototype,"onClick",void 0);customElements.define("google-pay-button",GooglePayButton);/**
   ...
   */_exports.$index=index;"use strict";const nativeShadow=!(window.ShadyDOM&&window.ShadyDOM.inUse);_exports.nativeShadow=nativeShadow;let nativeCssVariables_;/**
...
return polymerElementBase._addTemplatePropertyEffect.call(this,templateInfo,prop,effect)}}return PolymerElement});/**
     ...
     * @return {void}
     */_exports.ElementMixin=ElementMixin;const updateStyles=function(props){if(window.ShadyCSS){window.ShadyCSS.styleDocument(props)}};_exports.updateStyles=updateStyles;var elementMixin={version:version$1,builtCSS:builtCSS,ElementMixin:ElementMixin,updateStyles:updateStyles};_exports.$elementMixin=elementMixin;class Debouncer{constructor(){this._asyncModule=null;this._callback=null;this._timer=null}/**
...
debouncerQueue.forEach(debouncer=>{try{debouncer.flush()}catch(e){setTimeout(()=>{throw e})}});return didFlush};_exports.flushDebouncers=flushDebouncers;var debounce$1={Debouncer:Debouncer,enqueueDebouncer:enqueueDebouncer,flushDebouncers:flushDebouncers};_exports.$debounce=debounce$1;let HAS_NATIVE_TA="string"===typeof document.head.style.touchAction,GESTURE_KEY="__polymerGestures",HANDLED_OBJ="__polymerGesturesHandled",TOUCH_ACTION="__polymerGesturesTouchAction",TAP_DISTANCE=25,TRACK_DISTANCE=5,TRACK_LENGTH=2,MOUSE_TIMEOUT=2500,MOUSE_EVENTS=["mousedown","mousemove","mouseup","click"],MOUSE_WHICH_TO_BUTTONS=[0,1,4,2],MOUSE_HAS_BUTTONS=function(){try{return 1===new MouseEvent("test",{buttons:1}).buttons}catch(e){return!1}}();/**
...
document.documentElement.scrollTop=document.body.scrollTop=this.__scrollTop;document.documentElement.scrollLeft=document.body.scrollLeft=this.__scrollLeft}}};_exports.IronOverlayBehaviorImpl=IronOverlayBehaviorImpl;const composedParent=node=>node.assignedSlot||node.parentNode||node.host,composedContains=(ancestor,descendant)=>{for(let element=descendant;element;element=composedParent(element)){if(element===ancestor){return!0}}return!1},IronOverlayBehavior=[IronFitBehavior,IronResizableBehavior,IronOverlayBehaviorImpl];_exports.IronOverlayBehavior=IronOverlayBehavior;/**
                                                                                                       ...
                                                                                                       */ /**
                                                                                                           ...
                                                                                                           */ /**
                                                                                                               ...
                                                                                                               */var ironOverlayBehavior={IronOverlayBehaviorImpl:IronOverlayBehaviorImpl,IronOverlayBehavior:IronOverlayBehavior};_exports.$ironOverlayBehavior=ironOverlayBehavior;class IronSelection{/**
