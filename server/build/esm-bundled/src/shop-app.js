...
/** @override */disconnectedCallback(){if(!this.__isUpgradeDisabled){super.disconnectedCallback()}}}return DisableUpgradeClass});var disableUpgradeMixin={findObservedAttributesGetter:findObservedAttributesGetter,DisableUpgradeMixin:DisableUpgradeMixin};const bundledImportMeta$1={...import.meta,url:new URL("../node_assets/%40polymer/polymer/lib/legacy/legacy-element-mixin.js",import.meta.url).href},DISABLED_ATTR$1="disable-upgrade";let styleInterface=window.ShadyCSS;/**
