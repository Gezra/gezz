define(["exports","./shop-app.js"],function(_exports,_shopApp){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0/* ignoreName */ /* skipSlots */});_exports.PaperSpinnerBehavior=_exports.PaperRippleBehavior=_exports.PaperInkyFocusBehaviorImpl=_exports.PaperInkyFocusBehavior=_exports.IronMeta=_exports.IronControlState=_exports.IronButtonStateImpl=_exports.IronButtonState=_exports.AppStorageBehavior=_exports.$paperSpinnerBehavior=_exports.$paperRippleBehavior=_exports.$paperInkyFocusBehavior=_exports.$ironMeta=_exports.$ironControlState=_exports.$ironButtonState=_exports.$appStorageBehavior=void 0;function _templateObject16_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style include=\"shop-select\">\n\n      :host {\n        @apply --layout-horizontal;\n        position: relative;\n        margin-bottom: 24px;\n      }\n\n      shop-image {\n        width: 72px;\n        height: 72px;\n      }\n\n      shop-select > select {\n        font-size: 16px;\n        padding-left: 40px;\n      }\n\n      shop-select > shop-md-decorator {\n        font-size: 12px;\n        border: none;\n      }\n\n      .name {\n        @apply --layout-flex-auto;\n        line-height: 20px;\n        font-weight: 500;\n        float: left;\n        width: calc(100% - 438px);\n        margin-top: 26px;\n        margin-right: 30px;\n      }\n\n      .name a {\n        display: inline-block;\n        max-width: 100%;\n        text-decoration: none;\n        color: var(--app-primary-color);\n        white-space: nowrap;\n        overflow: hidden;\n        text-overflow: ellipsis;\n      }\n\n      .price, .size {\n        display: inline-block;\n        white-space: nowrap;\n        color: var(--app-secondary-color);\n      }\n\n      .size {\n        min-width: 70px;\n        width: 144px;\n      }\n\n      .size > span {\n        margin-left: 10px;\n      }\n\n      .price {\n        min-width: 70px;\n        width: 100px;\n      }\n\n      .quantity {\n        min-width: 80px;\n        width: 160px;\n      }\n\n      .delete-button {\n        width: 34px;\n        height: 34px;\n        color: var(--app-secondary-color);\n        position: absolute;\n        top: 18px;\n        right: 0;\n      }\n\n      .flex {\n        @apply --layout-horizontal;\n        @apply --layout-flex-auto;\n        margin-left: 24px;\n      }\n\n      .detail {\n        @apply --layout-horizontal;\n        @apply --layout-center;\n        margin-top: 26px;\n        margin-right: 30px;\n        height: 20px;\n      }\n\n      @media (max-width: 767px) {\n        .flex {\n          @apply --layout-vertical;\n          margin-left: 10px;\n        }\n\n        .name {\n          margin-top: 16px;\n          margin-right: 0;\n          width: calc(100% - 40px);\n        }\n\n        .detail {\n          @apply --layout-self-end;\n          margin: 10px 10px 0 0;\n        }\n\n        .quantity, .size, .price {\n          text-align: right;\n          width: auto;\n        }\n\n        .delete-button {\n          top: 8px;\n        }\n      }\n\n      @media (max-width: 360px) {\n        .name {\n          margin-top: 0;\n        }\n\n        .detail {\n          @apply --layout-vertical;\n          @apply --layout-start;\n          @apply --layout-self-start;\n          height: auto;\n          margin-top: 0;\n        }\n\n        .delete-button {\n          top: -6px;\n        }\n\n        shop-select > select {\n          padding: 2px 24px 2px 40px;\n        }\n\n        .quantity, .size, .price {\n          text-align: left;\n          width: auto;\n        }\n      }\n\n    </style>\n\n    <a href$=\"/detail/[[entry.item.category]]/[[entry.item.name]]\" title$=\"[[entry.item.title]]\">\n      <shop-image src=\"[[entry.item.image]]\" alt=\"[[entry.item.title]]\"></shop-image>\n    </a>\n    <div class=\"flex\">\n      <div class=\"name\">\n        <a href$=\"/detail/[[entry.item.category]]/[[entry.item.name]]\">[[entry.item.title]]</a>\n      </div>\n      <div class=\"detail\">\n        <div class=\"quantity\">\n          <shop-select>\n            <label prefix=\"\">Qty:</label>\n            <select id=\"quantitySelect\" aria-label=\"Change quantity\" value=\"[[entry.quantity]]\" on-change=\"_quantityChange\">\n              <option value=\"1\">1</option>\n              <option value=\"2\">2</option>\n              <option value=\"3\">3</option>\n              <option value=\"4\">4</option>\n              <option value=\"5\">5</option>\n              <option value=\"6\">6</option>\n              <option value=\"7\">7</option>\n              <option value=\"8\">8</option>\n              <option value=\"9\">9</option>\n              <option value=\"10\">10</option>\n              <option value=\"11\">11</option>\n              <option value=\"12\">12</option>\n            </select>\n            <shop-md-decorator aria-hidden=\"true\"></shop-md-decorator>\n          </shop-select>\n        </div>\n        <div class=\"size\">Size: <span>[[entry.size]]</span></div>\n        <div class=\"price\">[[_formatPrice(entry.item.price)]]</div>\n\n        <!--\n          Use on-click instead of on-tap to prevent the next cart item to be focused\n        -->\n        <paper-icon-button class=\"delete-button\" icon=\"close\" aria-label$=\"Delete item [[entry.item.title]]\" on-click=\"_removeItem\"></paper-icon-button>\n      </div>\n    </div>\n    "],["\n    <style include=\"shop-select\">\n\n      :host {\n        @apply --layout-horizontal;\n        position: relative;\n        margin-bottom: 24px;\n      }\n\n      shop-image {\n        width: 72px;\n        height: 72px;\n      }\n\n      shop-select > select {\n        font-size: 16px;\n        padding-left: 40px;\n      }\n\n      shop-select > shop-md-decorator {\n        font-size: 12px;\n        border: none;\n      }\n\n      .name {\n        @apply --layout-flex-auto;\n        line-height: 20px;\n        font-weight: 500;\n        float: left;\n        width: calc(100% - 438px);\n        margin-top: 26px;\n        margin-right: 30px;\n      }\n\n      .name a {\n        display: inline-block;\n        max-width: 100%;\n        text-decoration: none;\n        color: var(--app-primary-color);\n        white-space: nowrap;\n        overflow: hidden;\n        text-overflow: ellipsis;\n      }\n\n      .price, .size {\n        display: inline-block;\n        white-space: nowrap;\n        color: var(--app-secondary-color);\n      }\n\n      .size {\n        min-width: 70px;\n        width: 144px;\n      }\n\n      .size > span {\n        margin-left: 10px;\n      }\n\n      .price {\n        min-width: 70px;\n        width: 100px;\n      }\n\n      .quantity {\n        min-width: 80px;\n        width: 160px;\n      }\n\n      .delete-button {\n        width: 34px;\n        height: 34px;\n        color: var(--app-secondary-color);\n        position: absolute;\n        top: 18px;\n        right: 0;\n      }\n\n      .flex {\n        @apply --layout-horizontal;\n        @apply --layout-flex-auto;\n        margin-left: 24px;\n      }\n\n      .detail {\n        @apply --layout-horizontal;\n        @apply --layout-center;\n        margin-top: 26px;\n        margin-right: 30px;\n        height: 20px;\n      }\n\n      @media (max-width: 767px) {\n        .flex {\n          @apply --layout-vertical;\n          margin-left: 10px;\n        }\n\n        .name {\n          margin-top: 16px;\n          margin-right: 0;\n          width: calc(100% - 40px);\n        }\n\n        .detail {\n          @apply --layout-self-end;\n          margin: 10px 10px 0 0;\n        }\n\n        .quantity, .size, .price {\n          text-align: right;\n          width: auto;\n        }\n\n        .delete-button {\n          top: 8px;\n        }\n      }\n\n      @media (max-width: 360px) {\n        .name {\n          margin-top: 0;\n        }\n\n        .detail {\n          @apply --layout-vertical;\n          @apply --layout-start;\n          @apply --layout-self-start;\n          height: auto;\n          margin-top: 0;\n        }\n\n        .delete-button {\n          top: -6px;\n        }\n\n        shop-select > select {\n          padding: 2px 24px 2px 40px;\n        }\n\n        .quantity, .size, .price {\n          text-align: left;\n          width: auto;\n        }\n      }\n\n    </style>\n\n    <a href\\$=\"/detail/[[entry.item.category]]/[[entry.item.name]]\" title\\$=\"[[entry.item.title]]\">\n      <shop-image src=\"[[entry.item.image]]\" alt=\"[[entry.item.title]]\"></shop-image>\n    </a>\n    <div class=\"flex\">\n      <div class=\"name\">\n        <a href\\$=\"/detail/[[entry.item.category]]/[[entry.item.name]]\">[[entry.item.title]]</a>\n      </div>\n      <div class=\"detail\">\n        <div class=\"quantity\">\n          <shop-select>\n            <label prefix=\"\">Qty:</label>\n            <select id=\"quantitySelect\" aria-label=\"Change quantity\" value=\"[[entry.quantity]]\" on-change=\"_quantityChange\">\n              <option value=\"1\">1</option>\n              <option value=\"2\">2</option>\n              <option value=\"3\">3</option>\n              <option value=\"4\">4</option>\n              <option value=\"5\">5</option>\n              <option value=\"6\">6</option>\n              <option value=\"7\">7</option>\n              <option value=\"8\">8</option>\n              <option value=\"9\">9</option>\n              <option value=\"10\">10</option>\n              <option value=\"11\">11</option>\n              <option value=\"12\">12</option>\n            </select>\n            <shop-md-decorator aria-hidden=\"true\"></shop-md-decorator>\n          </shop-select>\n        </div>\n        <div class=\"size\">Size: <span>[[entry.size]]</span></div>\n        <div class=\"price\">[[_formatPrice(entry.item.price)]]</div>\n\n        <!--\n          Use on-click instead of on-tap to prevent the next cart item to be focused\n        -->\n        <paper-icon-button class=\"delete-button\" icon=\"close\" aria-label\\$=\"Delete item [[entry.item.title]]\" on-click=\"_removeItem\"></paper-icon-button>\n      </div>\n    </div>\n    "]);_templateObject16_d0ead910917011eda892694d5d951519=function _templateObject16_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject15_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style include=\"shop-button\">\n\n      :host {\n        display: block;\n        text-align: center;\n        color: var(--app-secondary-color);\n      }\n\n      iron-icon {\n        display: inline-block;\n        width: 60px;\n        height: 60px;\n      }\n\n      h1 {\n        margin: 50px 0 50px 0;\n        font-weight: 300;\n      }\n\n    </style>\n\n    <div>\n      <iron-icon icon=\"error\"></iron-icon>\n      <h1>Sorry, we couldn't find that page</h1>\n    </div>\n    <shop-button>\n      <a href=\"/\">Go to the home page</a>\n    </shop-button>\n"]);_templateObject15_d0ead910917011eda892694d5d951519=function _templateObject15_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject14_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style include=\"shop-button\">\n\n      :host {\n        display: block;\n        padding: 40px 20px;\n        text-align: center;\n        color: var(--app-secondary-color);\n      }\n\n      iron-icon {\n        display: inline-block;\n        width: 30px;\n        height: 30px;\n      }\n\n      h1 {\n        margin: 50px 0 10px 0;\n        font-weight: 300;\n      }\n\n      p {\n        margin: 0;\n      }\n\n      shop-button {\n        margin-top: 50px;\n      }\n\n    </style>\n\n    <div hidden$=\"[[offline]]\">\n      <h1>Couldn't reach the server</h1>\n    </div>\n    <div hidden$=\"[[!offline]]\">\n      <iron-icon icon=\"perm-scan-wifi\"></iron-icon>\n      <h1>No internet connection</h1>\n      <p>Check if your device is connected to a mobile network or WiFi.</p>\n    </div>\n    <shop-button>\n      <button on-click=\"_tryReconnect\">Try Again</button>\n    </shop-button>\n"],["\n    <style include=\"shop-button\">\n\n      :host {\n        display: block;\n        padding: 40px 20px;\n        text-align: center;\n        color: var(--app-secondary-color);\n      }\n\n      iron-icon {\n        display: inline-block;\n        width: 30px;\n        height: 30px;\n      }\n\n      h1 {\n        margin: 50px 0 10px 0;\n        font-weight: 300;\n      }\n\n      p {\n        margin: 0;\n      }\n\n      shop-button {\n        margin-top: 50px;\n      }\n\n    </style>\n\n    <div hidden\\$=\"[[offline]]\">\n      <h1>Couldn't reach the server</h1>\n    </div>\n    <div hidden\\$=\"[[!offline]]\">\n      <iron-icon icon=\"perm-scan-wifi\"></iron-icon>\n      <h1>No internet connection</h1>\n      <p>Check if your device is connected to a mobile network or WiFi.</p>\n    </div>\n    <shop-button>\n      <button on-click=\"_tryReconnect\">Try Again</button>\n    </shop-button>\n"]);_templateObject14_d0ead910917011eda892694d5d951519=function _templateObject14_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject13_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      [hidden] {\n        display: none !important;\n      }\n\n      :host {\n        display: inline-block;\n        position: relative;\n      }\n\n      #overlay {\n        pointer-events: none;\n        display: none;\n        position: absolute;\n        top: 0;\n        right: 0;\n        bottom: 0;\n        left: 0;\n        @apply --shop-tab-overlay;\n      }\n\n      :host(.shop-tabs-overlay-static-above) #overlay {\n        display: block;\n      }\n    </style>\n    <div id=\"overlay\"></div>\n    <shop-ripple-container>\n      <slot></slot>\n    </shop-ripple-container>\n    "]);_templateObject13_d0ead910917011eda892694d5d951519=function _templateObject13_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject12_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: inline-block;\n        position: relative;\n      }\n\n      paper-ripple {\n        color: var(--app-accent-color);\n      }\n    </style>\n    <slot></slot>\n    "]);_templateObject12_d0ead910917011eda892694d5d951519=function _templateObject12_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject11_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        @apply --layout;\n        @apply --layout-center-center;\n      }\n\n      #container {\n        position: relative;\n      }\n\n      shop-tabs-overlay {\n        @apply --shop-tab-overlay;\n      }\n    </style>\n    <div id=\"container\">\n      <shop-tabs-overlay id=\"overlay\"></shop-tabs-overlay>\n      <slot></slot>\n    </div>\n    "]);_templateObject11_d0ead910917011eda892694d5d951519=function _templateObject11_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject10_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        position: absolute;\n        display: none;\n        pointer-events: none;\n        opacity: 0;\n        top: 0;\n        right: 0;\n        bottom: 0;\n        left: 0;\n        transition-property: top, right, bottom, left, opacity;\n      }\n    </style>\n    "]);_templateObject10_d0ead910917011eda892694d5d951519=function _templateObject10_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject9_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        position: fixed;\n        left: calc(50% - 160px);\n        right: calc(50% - 160px);\n        bottom: 0;\n        background-color: var(--app-primary-color);\n        box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n        color: white;\n        width: 320px;\n        padding: 12px;\n        visibility: hidden;\n        text-align: center;\n        will-change: transform;\n        -webkit-transform: translate3d(0, 100%, 0);\n        transform: translate3d(0, 100%, 0);\n        transition-property: visibility, -webkit-transform, opacity;\n        transition-property: visibility, transform, opacity;\n        transition-duration: 0.2s;\n      }\n      :host(.opened) {\n        visibility: visible;\n        -webkit-transform: translate3d(0, 0, 0);\n        transform: translate3d(0, 0, 0);\n      }\n      @media (max-width: 767px) {\n        :host {\n          top: auto;\n          bottom: 0;\n          left: 0;\n          right: 0;\n          width: auto;\n          -webkit-transform: translate3d(0, 100%, 0);\n          transform: translate3d(0, 100%, 0);\n          z-index: 1;\n        }\n      }\n    </style>\n\n    <slot></slot>\n"]);_templateObject9_d0ead910917011eda892694d5d951519=function _templateObject9_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject8_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style include=\"shop-button\">\n\n      :host {\n        display: block;\n        position: fixed;\n        background-color: #FFF;\n        box-shadow: 0 0 10px rgba(0, 0, 0, 0.2);\n        width: 320px;\n        padding: 12px;\n        visibility: hidden;\n        will-change: transform;\n        top: 56px;\n        right: 16px;\n        -webkit-transform: translate3d(calc(100% + 16px), 0, 0);\n        transform: translate3d(calc(100% + 16px), 0, 0);\n        transition-property: visibility, -webkit-transform;\n        transition-property: visibility, transform;\n        transition-duration: 0.2s;\n        transition-delay: 0.1s;\n      }\n\n      :host(.opened) {\n        visibility: visible;\n        -webkit-transform: translate3d(0, 0, 0);\n        transform: translate3d(0, 0, 0);\n      }\n\n      .layout-horizontal {\n        @apply --layout-horizontal;\n      }\n\n      .label {\n        @apply --layout-flex;\n        line-height: 24px;\n        margin: 8px;\n      }\n\n      .modal-button {\n        @apply --layout-flex;\n        margin: 16px 8px;\n      }\n\n      .modal-button > a {\n        box-sizing: border-box;\n        width: 100%;\n        padding: 8px 24px;\n      }\n\n      #closeBtn {\n        position: absolute;\n        right: 5px;\n        top: 5px;\n      }\n\n      @media (max-width: 767px) {\n\n        :host {\n          top: auto;\n          bottom: 0;\n          left: 0;\n          right: 0;\n          width: auto;\n          -webkit-transform: translate3d(0, 100%, 0);\n          transform: translate3d(0, 100%, 0);\n        }\n\n      }\n\n    </style>\n\n    <div class=\"layout-horizontal\">\n      <div class=\"label\">Added to cart</div>\n    </div>\n    <div class=\"layout-horizontal\">\n      <shop-button class=\"modal-button\">\n        <a href=\"/cart\" on-click=\"close\" id=\"viewCartAnchor\">View Cart</a>\n      </shop-button>\n      <shop-button class=\"modal-button\">\n        <a href=\"/checkout\" on-click=\"close\">Checkout</a>\n      </shop-button>\n    </div>\n\n    <paper-icon-button icon=\"close\" id=\"closeBtn\" aria-label=\"Close dialog\" on-click=\"close\"></paper-icon-button>\n"]);_templateObject8_d0ead910917011eda892694d5d951519=function _templateObject8_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject7_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <app-localstorage-document key=\"shop-cart-data\" data=\"{{cart}}\"></app-localstorage-document>\n"]);_templateObject7_d0ead910917011eda892694d5d951519=function _templateObject7_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject6_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n  <style include=\"paper-spinner-styles\"></style>\n\n  <div id=\"spinnerContainer\" class-name=\"[[__computeContainerClasses(active, __coolingDown)]]\" on-animationend=\"__reset\" on-webkit-animation-end=\"__reset\">\n    <div class=\"spinner-layer\">\n      <div class=\"circle-clipper left\">\n        <div class=\"circle\"></div>\n      </div>\n      <div class=\"circle-clipper right\">\n        <div class=\"circle\"></div>\n      </div>\n    </div>\n  </div>\n"]);_templateObject6_d0ead910917011eda892694d5d951519=function _templateObject6_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject5_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: inline-block;\n        position: relative;\n        padding: 8px;\n        outline: none;\n        -webkit-user-select: none;\n        -moz-user-select: none;\n        -ms-user-select: none;\n        user-select: none;\n        cursor: pointer;\n        z-index: 0;\n        line-height: 1;\n\n        width: 40px;\n        height: 40px;\n\n        /*\n          NOTE: Both values are needed, since some phones require the value to\n          be `transparent`.\n        */\n        -webkit-tap-highlight-color: rgba(0, 0, 0, 0);\n        -webkit-tap-highlight-color: transparent;\n\n        /* Because of polymer/2558, this style has lower specificity than * */\n        box-sizing: border-box !important;\n\n        @apply --paper-icon-button;\n      }\n\n      :host #ink {\n        color: var(--paper-icon-button-ink-color, var(--primary-text-color));\n        opacity: 0.6;\n      }\n\n      :host([disabled]) {\n        color: var(--paper-icon-button-disabled-text, var(--disabled-text-color));\n        pointer-events: none;\n        cursor: auto;\n\n        @apply --paper-icon-button-disabled;\n      }\n\n      :host([hidden]) {\n        display: none !important;\n      }\n\n      :host(:hover) {\n        @apply --paper-icon-button-hover;\n      }\n\n      iron-icon {\n        --iron-icon-width: 100%;\n        --iron-icon-height: 100%;\n      }\n    </style>\n\n    <iron-icon id=\"icon\" src=\"[[src]]\" icon=\"[[icon]]\"\n               alt$=\"[[alt]]\"></iron-icon>\n  "],["\n    <style>\n      :host {\n        display: inline-block;\n        position: relative;\n        padding: 8px;\n        outline: none;\n        -webkit-user-select: none;\n        -moz-user-select: none;\n        -ms-user-select: none;\n        user-select: none;\n        cursor: pointer;\n        z-index: 0;\n        line-height: 1;\n\n        width: 40px;\n        height: 40px;\n\n        /*\n          NOTE: Both values are needed, since some phones require the value to\n          be \\`transparent\\`.\n        */\n        -webkit-tap-highlight-color: rgba(0, 0, 0, 0);\n        -webkit-tap-highlight-color: transparent;\n\n        /* Because of polymer/2558, this style has lower specificity than * */\n        box-sizing: border-box !important;\n\n        @apply --paper-icon-button;\n      }\n\n      :host #ink {\n        color: var(--paper-icon-button-ink-color, var(--primary-text-color));\n        opacity: 0.6;\n      }\n\n      :host([disabled]) {\n        color: var(--paper-icon-button-disabled-text, var(--disabled-text-color));\n        pointer-events: none;\n        cursor: auto;\n\n        @apply --paper-icon-button-disabled;\n      }\n\n      :host([hidden]) {\n        display: none !important;\n      }\n\n      :host(:hover) {\n        @apply --paper-icon-button-hover;\n      }\n\n      iron-icon {\n        --iron-icon-width: 100%;\n        --iron-icon-height: 100%;\n      }\n    </style>\n\n    <iron-icon id=\"icon\" src=\"[[src]]\" icon=\"[[icon]]\"\n               alt$=\"[[alt]]\"></iron-icon>\n  "]);_templateObject5_d0ead910917011eda892694d5d951519=function _templateObject5_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject4_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        position: absolute;\n        border-radius: inherit;\n        overflow: hidden;\n        top: 0;\n        left: 0;\n        right: 0;\n        bottom: 0;\n\n        /* See PolymerElements/paper-behaviors/issues/34. On non-Chrome browsers,\n         * creating a node (with a position:absolute) in the middle of an event\n         * handler \"interrupts\" that event handler (which happens when the\n         * ripple is created on demand) */\n        pointer-events: none;\n      }\n\n      :host([animating]) {\n        /* This resolves a rendering issue in Chrome (as of 40) where the\n           ripple is not properly clipped by its parent (which may have\n           rounded corners). See: http://jsbin.com/temexa/4\n\n           Note: We only apply this style conditionally. Otherwise, the browser\n           will create a new compositing layer for every ripple element on the\n           page, and that would be bad. */\n        -webkit-transform: translate(0, 0);\n        transform: translate3d(0, 0, 0);\n      }\n\n      #background,\n      #waves,\n      .wave-container,\n      .wave {\n        pointer-events: none;\n        position: absolute;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n      }\n\n      #background,\n      .wave {\n        opacity: 0;\n      }\n\n      #waves,\n      .wave {\n        overflow: hidden;\n      }\n\n      .wave-container,\n      .wave {\n        border-radius: 50%;\n      }\n\n      :host(.circle) #background,\n      :host(.circle) #waves {\n        border-radius: 50%;\n      }\n\n      :host(.circle) .wave-container {\n        overflow: hidden;\n      }\n    </style>\n\n    <div id=\"background\"></div>\n    <div id=\"waves\"></div>\n"]);_templateObject4_d0ead910917011eda892694d5d951519=function _templateObject4_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject3_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        @apply --layout-inline;\n        @apply --layout-center-center;\n        position: relative;\n\n        vertical-align: middle;\n\n        fill: var(--iron-icon-fill-color, currentcolor);\n        stroke: var(--iron-icon-stroke-color, none);\n\n        width: var(--iron-icon-width, 24px);\n        height: var(--iron-icon-height, 24px);\n        @apply --iron-icon;\n      }\n\n      :host([hidden]) {\n        display: none;\n      }\n    </style>\n"]);_templateObject3_d0ead910917011eda892694d5d951519=function _templateObject3_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject2_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n      }\n    </style>\n\n    <!-- This form is used to collect the elements that should be submitted -->\n    <slot></slot>\n\n    <!-- This form is used for submission -->\n    <form id=\"helper\" action$=\"[[action]]\" method$=\"[[method]]\" enctype$=\"[[enctype]]\"></form>\n"],["\n    <style>\n      :host {\n        display: block;\n      }\n    </style>\n\n    <!-- This form is used to collect the elements that should be submitted -->\n    <slot></slot>\n\n    <!-- This form is used for submission -->\n    <form id=\"helper\" action\\$=\"[[action]]\" method\\$=\"[[method]]\" enctype\\$=\"[[enctype]]\"></form>\n"]);_templateObject2_d0ead910917011eda892694d5d951519=function _templateObject2_d0ead910917011eda892694d5d951519(){return data};return data}function _templateObject_d0ead910917011eda892694d5d951519(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        position: fixed;\n        top: -120px;\n        right: 0;\n        bottom: -120px;\n        left: 0;\n\n        visibility: hidden;\n\n        transition-property: visibility;\n      }\n\n      :host([opened]) {\n        visibility: visible;\n      }\n\n      :host([persistent]) {\n        width: var(--app-drawer-width, 256px);\n      }\n\n      :host([persistent][position=left]) {\n        right: auto;\n      }\n\n      :host([persistent][position=right]) {\n        left: auto;\n      }\n\n      #contentContainer {\n        position: absolute;\n        top: 0;\n        bottom: 0;\n        left: 0;\n\n        width: var(--app-drawer-width, 256px);\n        padding: var(--app-drawer-content-padding, 120px 0);\n\n        transition-property: -webkit-transform;\n        transition-property: transform;\n        -webkit-transform: translate3d(-100%, 0, 0);\n        transform: translate3d(-100%, 0, 0);\n\n        background-color: #FFF;\n\n        @apply --app-drawer-content-container;\n      }\n\n      #contentContainer[persistent] {\n        width: 100%;\n      }\n\n      #contentContainer[position=right] {\n        right: 0;\n        left: auto;\n\n        -webkit-transform: translate3d(100%, 0, 0);\n        transform: translate3d(100%, 0, 0);\n      }\n\n      #contentContainer[swipe-open]::after {\n        position: fixed;\n        top: 0;\n        bottom: 0;\n        left: 100%;\n\n        visibility: visible;\n\n        width: 20px;\n\n        content: '';\n      }\n\n      #contentContainer[swipe-open][position=right]::after {\n        right: 100%;\n        left: auto;\n      }\n\n      #contentContainer[opened] {\n        -webkit-transform: translate3d(0, 0, 0);\n        transform: translate3d(0, 0, 0);\n      }\n\n      #scrim {\n        position: absolute;\n        top: 0;\n        right: 0;\n        bottom: 0;\n        left: 0;\n\n        transition-property: opacity;\n        -webkit-transform: translateZ(0);\n        transform:  translateZ(0);\n\n        opacity: 0;\n        background: var(--app-drawer-scrim-background, rgba(0, 0, 0, 0.5));\n      }\n\n      #scrim.visible {\n        opacity: 1;\n      }\n\n      :host([no-transition]) #contentContainer {\n        transition-property: none;\n      }\n    </style>\n\n    <div id=\"scrim\" on-click=\"close\"></div>\n\n    <!-- HACK(keanulee): Bind attributes here (in addition to :host) for styling to workaround Safari\n    bug. https://bugs.webkit.org/show_bug.cgi?id=170762 -->\n    <div id=\"contentContainer\" opened$=\"[[opened]]\" persistent$=\"[[persistent]]\" position$=\"[[position]]\" swipe-open$=\"[[swipeOpen]]\">\n      <slot></slot>\n    </div>\n"],["\n    <style>\n      :host {\n        position: fixed;\n        top: -120px;\n        right: 0;\n        bottom: -120px;\n        left: 0;\n\n        visibility: hidden;\n\n        transition-property: visibility;\n      }\n\n      :host([opened]) {\n        visibility: visible;\n      }\n\n      :host([persistent]) {\n        width: var(--app-drawer-width, 256px);\n      }\n\n      :host([persistent][position=left]) {\n        right: auto;\n      }\n\n      :host([persistent][position=right]) {\n        left: auto;\n      }\n\n      #contentContainer {\n        position: absolute;\n        top: 0;\n        bottom: 0;\n        left: 0;\n\n        width: var(--app-drawer-width, 256px);\n        padding: var(--app-drawer-content-padding, 120px 0);\n\n        transition-property: -webkit-transform;\n        transition-property: transform;\n        -webkit-transform: translate3d(-100%, 0, 0);\n        transform: translate3d(-100%, 0, 0);\n\n        background-color: #FFF;\n\n        @apply --app-drawer-content-container;\n      }\n\n      #contentContainer[persistent] {\n        width: 100%;\n      }\n\n      #contentContainer[position=right] {\n        right: 0;\n        left: auto;\n\n        -webkit-transform: translate3d(100%, 0, 0);\n        transform: translate3d(100%, 0, 0);\n      }\n\n      #contentContainer[swipe-open]::after {\n        position: fixed;\n        top: 0;\n        bottom: 0;\n        left: 100%;\n\n        visibility: visible;\n\n        width: 20px;\n\n        content: '';\n      }\n\n      #contentContainer[swipe-open][position=right]::after {\n        right: 100%;\n        left: auto;\n      }\n\n      #contentContainer[opened] {\n        -webkit-transform: translate3d(0, 0, 0);\n        transform: translate3d(0, 0, 0);\n      }\n\n      #scrim {\n        position: absolute;\n        top: 0;\n        right: 0;\n        bottom: 0;\n        left: 0;\n\n        transition-property: opacity;\n        -webkit-transform: translateZ(0);\n        transform:  translateZ(0);\n\n        opacity: 0;\n        background: var(--app-drawer-scrim-background, rgba(0, 0, 0, 0.5));\n      }\n\n      #scrim.visible {\n        opacity: 1;\n      }\n\n      :host([no-transition]) #contentContainer {\n        transition-property: none;\n      }\n    </style>\n\n    <div id=\"scrim\" on-click=\"close\"></div>\n\n    <!-- HACK(keanulee): Bind attributes here (in addition to :host) for styling to workaround Safari\n    bug. https://bugs.webkit.org/show_bug.cgi?id=170762 -->\n    <div id=\"contentContainer\" opened\\$=\"[[opened]]\" persistent\\$=\"[[persistent]]\" position\\$=\"[[position]]\" swipe-open\\$=\"[[swipeOpen]]\">\n      <slot></slot>\n    </div>\n"]);_templateObject_d0ead910917011eda892694d5d951519=function _templateObject_d0ead910917011eda892694d5d951519(){return data};return data}(0,_shopApp.Polymer)({/** @override */_template:(0,_shopApp.html$1)(_templateObject_d0ead910917011eda892694d5d951519()),is:"app-drawer",properties:{/**
...
}}};/** @polymerBehavior */_exports.IronButtonStateImpl=IronButtonStateImpl;var IronButtonState=[_shopApp.IronA11yKeysBehavior,IronButtonStateImpl];_exports.IronButtonState=IronButtonState;var ironButtonState={IronButtonStateImpl:IronButtonStateImpl,IronButtonState:IronButtonState};_exports.$ironButtonState=ironButtonState;(0,_shopApp.Polymer)({_template:(0,_shopApp.html$1)(_templateObject2_d0ead910917011eda892694d5d951519()),is:"iron-form",properties:{/*
...
IronMeta[" "]=function(){};IronMeta.types={};var metaDatas=IronMeta.types;/**
   ...
   * @return {*}
   */byKey:function byKey(key){return new IronMeta({type:this.type,key:key}).value}});var ironMeta={IronMeta:IronMeta};_exports.$ironMeta=ironMeta;(0,_shopApp.Polymer)({_template:(0,_shopApp.html$1)(_templateObject3_d0ead910917011eda892694d5d951519()),is:"iron-icon",properties:{/**
...
this.waveContainer.style.webkitTransform="translate("+dx+"px, "+dy+"px)";this.waveContainer.style.transform="translate3d("+dx+"px, "+dy+"px, 0)";this.wave.style.webkitTransform="scale("+scale+","+scale+")";this.wave.style.transform="scale3d("+scale+","+scale+",1)"},/** @param {Event=} event */downAction:function downAction(event){var xCenter=this.containerMetrics.width/2,yCenter=this.containerMetrics.height/2;this.resetInteractionState();this.mouseDownStart=Utility.now();if(this.center){this.xStart=xCenter;this.yStart=yCenter;this.slideDistance=Utility.distance(this.xStart,this.yStart,this.xEnd,this.yEnd)}else{this.xStart=event?event.detail.x-this.containerMetrics.boundingRect.left:this.containerMetrics.width/2;this.yStart=event?event.detail.y-this.containerMetrics.boundingRect.top:this.containerMetrics.height/2}if(this.recenters){this.xEnd=xCenter;this.yEnd=yCenter;this.slideDistance=Utility.distance(this.xStart,this.yStart,this.xEnd,this.yEnd)}this.maxRadius=this.containerMetrics.furthestCornerDistanceFrom(this.xStart,this.yStart);this.waveContainer.style.top=(this.containerMetrics.height-this.containerMetrics.size)/2+"px";this.waveContainer.style.left=(this.containerMetrics.width-this.containerMetrics.size)/2+"px";this.waveContainer.style.width=this.containerMetrics.size+"px";this.waveContainer.style.height=this.containerMetrics.size+"px"},/** @param {Event=} event */upAction:function upAction(event){if(!this.isMouseDown){return}this.mouseUpStart=Utility.now()},remove:function remove(){(0,_shopApp.dom)(this.waveContainer.parentNode).removeChild(this.waveContainer)}};/**
   ...
   @hero hero.svg
   @demo demo/index.html
   */(0,_shopApp.Polymer)({_template:(0,_shopApp.html$1)(_templateObject4_d0ead910917011eda892694d5d951519()),is:"paper-ripple",behaviors:[_shopApp.IronA11yKeysBehavior],properties:{/**
