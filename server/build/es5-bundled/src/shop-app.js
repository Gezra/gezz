...
***************************************************************************** */function __decorate(decorators,target,key,desc){var c=arguments.length,r=3>c?target:null===desc?desc=Object.getOwnPropertyDescriptor(target,key):desc,d;if("object"===("undefined"===typeof Reflect?"undefined":babelHelpers.typeof(Reflect))&&"function"===typeof Reflect.decorate)r=Reflect.decorate(decorators,target,key,desc);else for(var i=decorators.length-1;0<=i;i--){if(d=decorators[i])r=(3>c?d(r):3<c?d(target,key,r):d(target,key))||r}return 3<c&&r&&Object.defineProperty(target,key,r),r}function __awaiter(thisArg,_arguments,P,generator){function adopt(value){return babelHelpers.instanceof(value,P)?value:new P(function(resolve){resolve(value)})}return new(P||(P=Promise))(function(resolve,reject){function fulfilled(value){try{step(generator.next(value))}catch(e){reject(e)}}function rejected(value){try{step(generator["throw"](value))}catch(e){reject(e)}}function step(result){result.done?resolve(result.value):adopt(result.value).then(fulfilled,rejected)}step((generator=generator.apply(thisArg,_arguments||[])).next())})}/**
   ...
   */ /**
       ...
       */function getAttributeName(propertyName){return propertyName.replace(/[A-Z]+/g,function(sub){return"-".concat(sub)}).replace(/^-/,"").toLowerCase()}/**
   ...
   */function NotifyAttribute(attribute){return function(target,key){var attr=attribute||getAttributeName(key);if(target.addObservedAttribute){target.addObservedAttribute(attr)}Object.defineProperty(target,key,{get:function get(){return this.getAttribute(attr)},set:function set(value){if(null===value||value===void 0){this.removeAttribute(attr)}else{this.setAttribute(attr,value)}this.notifyPropertyChanged(key)},enumerable:!0,configurable:!0})}}/**
   ...
   */function NotifyBooleanAttribute(attribute){return function(target,key){var attr=attribute||getAttributeName(key);if(target.addObservedAttribute){target.addObservedAttribute(attr)}Object.defineProperty(target,key,{get:function get(){return this.hasAttribute(attr)},set:function set(value){if(value){this.setAttribute(attr,"")}else{this.removeAttribute(attr)}this.notifyPropertyChanged(key)},enumerable:!0,configurable:!0})}}/**
   ...
   * `NotifyAttribute`.
   */function Notify(attribute){if(attribute){return NotifyAttribute(attribute)}return function(target,key){Object.defineProperty(target,key,{get:function get(){return this["$__".concat(key)]},set:function set(value){this["$__".concat(key)]=value;this.notifyPropertyChanged(key)},enumerable:!0,configurable:!0})}}/**
   * Creates an alias for the given property with a getter and a setter.
   *
   * @param alias Name of the alias.
   */function Alias(alias){return function(target,key){Object.defineProperty(target,alias,{get:function get(){return this[key]},set:function set(value){this[key]=value},enumerable:!0,configurable:/* ignoreName */!1/* skipSlots */ /* skipSlots */})}}/**
   * Copyright 2020 Google LLC
   *
   * Licensed under the Apache License, Version 2.0 (the "License");
   * you may not use this file except in compliance with the License.
   ...
   */ /**
       ...
       */var cachedScripts={};/**
                         ...
                         */function loadScript(src){var existing=cachedScripts[src];if(existing){return existing}var promise=new Promise(function(resolve,reject){// Create script
var script=document.createElement("script");script.src=src;script.async=!0;// Script event listener callbacks for load and error
var onScriptLoad=function onScriptLoad(){resolve()},onScriptError=function onScriptError(){// eslint-disable-next-line @typescript-eslint/no-use-before-define
cleanup();// Remove from cachedScripts so that we can try loading again
delete cachedScripts[src];script.remove();reject(new Error("Unable to load script ".concat(src)))};script.addEventListener("load",onScriptLoad);script.addEventListener("error",onScriptError);// Add script to document body
...
function cleanup(){script.removeEventListener("load",onScriptLoad);script.removeEventListener("error",onScriptError)}});cachedScripts[src]=promise;return promise}/**
   ...
   */ /**
       ...
       */var ButtonManager=/*#__PURE__*/function(){function ButtonManager(options){var _this=this;babelHelpers.classCallCheck(this,ButtonManager);/**
     ...
     *
     * @private
     */this.handleClick=function(event){return __awaiter(_this,void 0,void 0,/*#__PURE__*/regeneratorRuntime.mark(function _callee(){var config,request,result;return regeneratorRuntime.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:config=this.config;if(config){_context.next=3;break}throw new Error("google-pay-button: Missing configuration");case 3:request=this.createLoadPaymentDataRequest(config);_context.prev=4;if(config.onClick){config.onClick(event)}if(!event.defaultPrevented){_context.next=8;break}return _context.abrupt("return");case 8:_context.next=10;return this.client.loadPaymentData(request);case 10:result=_context.sent;if(config.onLoadPaymentData){config.onLoadPaymentData(result)}_context.next=17;break;case 14:_context.prev=14;_context.t0=_context["catch"](4);if("CANCELED"===_context.t0.statusCode){if(config.onCancel){config.onCancel(_context.t0)}}else if(config.onError){config.onError(_context.t0)}else{console.error(_context.t0)}case 17:case"end":return _context.stop();}}},_callee,this,[[4,14]])}))};this.options=options}babelHelpers.createClass(ButtonManager,[{key:"getElement",value:function getElement(){return this.element}},{key:"isGooglePayLoaded",value:function isGooglePayLoaded(){var _a,_b;return"google"in(window||global)&&!!(null===(_b=null===(_a=null===google||void 0===google?void 0:google.payments)||void 0===_a?void 0:_a.api)||void 0===_b?void 0:_b.PaymentsClient)}},{key:"mount",value:function mount(element){return __awaiter(this,void 0,void 0,/*#__PURE__*/regeneratorRuntime.mark(function _callee2(){return regeneratorRuntime.wrap(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:if(this.isGooglePayLoaded()){_context2.next=3;break}_context2.next=3;return loadScript("https://pay.google.com/gp/p/js/pay.js");case 3:this.element=element;if(element){this.appendStyles();if(this.config){this.updateElement()}}case 5:case"end":return _context2.stop();}}},_callee2,this)}))}},{key:"unmount",value:function unmount(){this.element=void 0}},{key:"configure",value:function configure(newConfig){var promise=void 0;this.config=newConfig;if(!this.oldInvalidationValues||this.isClientInvalidated(newConfig)){promise=this.updateElement()}this.oldInvalidationValues=this.getInvalidationValues(newConfig);return null!==promise&&void 0!==promise?promise:Promise.resolve()}/**
     ...
     *
     * @private
     */},{key:"createClientOptions",value:function createClientOptions(config){var clientConfig={environment:config.environment,merchantInfo:this.createMerchantInfo(config)};if(config.onPaymentDataChanged||config.onPaymentAuthorized){clientConfig.paymentDataCallbacks={};if(config.onPaymentDataChanged){// eslint-disable-next-line @typescript-eslint/explicit-function-return-type
clientConfig.paymentDataCallbacks.onPaymentDataChanged=function(paymentData){var result=config.onPaymentDataChanged(paymentData);return result||{}}}if(config.onPaymentAuthorized){// eslint-disable-next-line @typescript-eslint/explicit-function-return-type
clientConfig.paymentDataCallbacks.onPaymentAuthorized=function(paymentData){var result=config.onPaymentAuthorized(paymentData);return result||{}}}}return clientConfig}},{key:"createIsReadyToPayRequest",value:function createIsReadyToPayRequest(config){var paymentRequest=config.paymentRequest,request={apiVersion:paymentRequest.apiVersion,apiVersionMinor:paymentRequest.apiVersionMinor,allowedPaymentMethods:paymentRequest.allowedPaymentMethods,existingPaymentMethodRequired:config.existingPaymentMethodRequired};return request}/**
     ...
     *
     * @private
     */},{key:"createLoadPaymentDataRequest",value:function createLoadPaymentDataRequest(config){var request=Object.assign(Object.assign({},config.paymentRequest),{merchantInfo:this.createMerchantInfo(config)});// TODO: #13 re-enable inferrence if/when we agree as a team
return request}},{key:"createMerchantInfo",value:function createMerchantInfo(config){var merchantInfo=Object.assign({},config.paymentRequest.merchantInfo);// apply softwareInfo if not set
if(!merchantInfo.softwareInfo){merchantInfo.softwareInfo={id:this.options.softwareInfoId,version:this.options.softwareInfoVersion}}return merchantInfo}},{key:"isMounted",value:function isMounted(){return null!=this.element&&!1!==this.element.isConnected}},{key:"removeButton",value:function removeButton(){if(babelHelpers.instanceof(this.element,ShadowRoot)||babelHelpers.instanceof(this.element,Element)){for(var _i=0,_Array$from=Array.from(this.element.children),child;_i<_Array$from.length;_i++){child=_Array$from[_i];if("STYLE"!==child.tagName){child.remove()}}}}},{key:"updateElement",value:function updateElement(){return __awaiter(this,void 0,void 0,/*#__PURE__*/regeneratorRuntime.mark(function _callee3(){var element,buttonOptions,rootNode,button,showButton,readyToPay,readyToPayResponse;return regeneratorRuntime.wrap(function _callee3$(_context3){while(1){switch(_context3.prev=_context3.next){case 0:if(this.isMounted()){_context3.next=2;break}return _context3.abrupt("return");case 2:element=this.getElement();if(this.config){_context3.next=5;break}throw new Error("google-pay-button: Missing configuration");case 5:// remove existing button
this.removeButton();this.client=new google.payments.api.PaymentsClient(this.createClientOptions(this.config));buttonOptions={buttonType:this.config.buttonType,buttonColor:this.config.buttonColor,buttonSizeMode:this.config.buttonSizeMode,buttonLocale:this.config.buttonLocale,onClick:this.handleClick,allowedPaymentMethods:this.config.paymentRequest.allowedPaymentMethods};rootNode=element.getRootNode();if(babelHelpers.instanceof(rootNode,ShadowRoot)){buttonOptions.buttonRootNode=rootNode}// pre-create button
button=this.client.createButton(buttonOptions);this.setClassName(element,[element.className,"not-ready"]);element.appendChild(button);showButton=!1;_context3.prev=14;_context3.next=17;return this.client.isReadyToPay(this.createIsReadyToPayRequest(this.config));case 17:readyToPay=_context3.sent;showButton=readyToPay.result&&!this.config.existingPaymentMethodRequired||readyToPay.result&&readyToPay.paymentMethodPresent&&this.config.existingPaymentMethodRequired||!1;_context3.next=24;break;case 21:_context3.prev=21;_context3.t0=_context3["catch"](14);if(this.config.onError){this.config.onError(_context3.t0)}else{console.error(_context3.t0)}case 24:if(this.isMounted()){_context3.next=26;break}return _context3.abrupt("return");case 26:if(showButton){try{this.client.prefetchPaymentData(this.createLoadPaymentDataRequest(this.config))}catch(err){console.log("Error with prefetch",err)}// remove hidden className
this.setClassName(element,(element.className||"").split(" ").filter(function(className){return className&&"not-ready"!==className}))}if(this.isReadyToPay!==(null===readyToPay||void 0===readyToPay?void 0:readyToPay.result)||this.paymentMethodPresent!==(null===readyToPay||void 0===readyToPay?void 0:readyToPay.paymentMethodPresent)){this.isReadyToPay=!!(null===readyToPay||void 0===readyToPay?void 0:readyToPay.result);this.paymentMethodPresent=null===readyToPay||void 0===readyToPay?void 0:readyToPay.paymentMethodPresent;if(this.config.onReadyToPayChange){readyToPayResponse={isButtonVisible:showButton,isReadyToPay:this.isReadyToPay};if(this.paymentMethodPresent){readyToPayResponse.paymentMethodPresent=this.paymentMethodPresent}this.config.onReadyToPayChange(readyToPayResponse)}}case 28:case"end":return _context3.stop();}}},_callee3,this,[[14,21]])}))}},{key:"setClassName",value:function setClassName(element,classNames){var className=classNames.filter(function(name){return name}).join(" ");if(className){element.className=className}else{element.removeAttribute("class")}}},{key:"appendStyles",value:function appendStyles(){var _a,_b,_c;if("undefined"===typeof document)return;var rootNode=null===(_a=this.element)||void 0===_a?void 0:_a.getRootNode(),styleId="default-google-style-".concat(this.options.cssSelector.replace(/[^\w-]+/g,""),"-").concat(null===(_b=this.config)||void 0===_b?void 0:_b.buttonLocale);// initialize styles if rendering on the client:
if(rootNode){if(!(null===(_c=rootNode.getElementById)||void 0===_c?void 0:_c.call(rootNode,styleId))){var _style=document.createElement("style");_style.id=styleId;_style.type="text/css";_style.innerHTML="\n          ".concat(this.options.cssSelector," {\n            display: inline-block;\n          }\n          ").concat(this.options.cssSelector,".not-ready {\n            width: 0;\n            height: 0;\n            overflow: hidden;\n          }\n        ");if(babelHelpers.instanceof(rootNode,Document)&&rootNode.head){rootNode.head.appendChild(_style)}else{rootNode.appendChild(_style)}}}}},{key:"isClientInvalidated",value:function isClientInvalidated(newConfig){var _this2=this;if(!this.oldInvalidationValues)return!0;var newValues=this.getInvalidationValues(newConfig);return newValues.some(function(value,index){return value!==_this2.oldInvalidationValues[index]})}},{key:"getInvalidationValues",value:function getInvalidationValues(config){var _a,_b;return[config.environment,config.existingPaymentMethodRequired,!!config.onPaymentDataChanged,!!config.onPaymentAuthorized,config.buttonColor,config.buttonType,config.buttonLocale,config.buttonSizeMode,config.paymentRequest.merchantInfo.merchantId,config.paymentRequest.merchantInfo.merchantName,null===(_a=config.paymentRequest.merchantInfo.softwareInfo)||void 0===_a?void 0:_a.id,null===(_b=config.paymentRequest.merchantInfo.softwareInfo)||void 0===_b?void 0:_b.version,config.paymentRequest.allowedPaymentMethods]}}]);return ButtonManager}(),name="@google-pay/button-element",version="3.0.0";/**
                        * Copyright 2020 Google LLC
                        *
                        * Licensed under the Apache License, Version 2.0 (the "License");
                        * you may not use this file except in compliance with the License.
                        ...
                        */ /**
                            ...
                            */function debounce(func){var wait=1<arguments.length&&arguments[1]!==void 0?arguments[1]:0,timeout;return function(){for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key]}window.clearTimeout(timeout);var later=function later(){timeout=void 0;return func.apply(void 0,args)};return new Promise(function(resolve){timeout=window.setTimeout(function(){var result=later();resolve(result)},wait)})}}/**
   * Copyright 2020 Google LLC
   *
   * Licensed under the Apache License, Version 2.0 (the "License");
   * you may not use this file except in compliance with the License.
   ...
   */ /**
       ...
       */var GooglePayButton=/*#__PURE__*/function(_HTMLElement){babelHelpers.inherits(GooglePayButton,_HTMLElement);function GooglePayButton(){var _this3;babelHelpers.classCallCheck(this,GooglePayButton);_this3=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(GooglePayButton).apply(this,arguments));_this3.manager=new ButtonManager({cssSelector:"google-pay-button",softwareInfoId:name,softwareInfoVersion:version});_this3.initializeButton=debounce(function(){if(!_this3.assertRequiredProperty("paymentRequest")){return}if(!_this3.assertRequiredProperty("environment")){return}var config={paymentRequest:_this3.paymentRequest,environment:_this3.environment,existingPaymentMethodRequired:_this3.existingPaymentMethodRequired,onPaymentDataChanged:_this3.onPaymentDataChanged,onPaymentAuthorized:_this3.onPaymentAuthorized,buttonColor:_this3.buttonColor,buttonType:_this3.buttonType,buttonSizeMode:_this3.buttonSizeMode,buttonLocale:_this3.buttonLocale,onReadyToPayChange:function onReadyToPayChange(result){if(_this3.onReadyToPayChange){_this3.onReadyToPayChange(result)}_this3.dispatch("readytopaychange",result)},onCancel:function onCancel(reason){if(_this3.onCancel){_this3.onCancel(reason)}_this3.dispatch("cancel",reason)},onError:function onError(error){var _a;if(_this3.onError){null===(_a=_this3.onError)||void 0===_a?void 0:_a.call(babelHelpers.assertThisInitialized(_this3),error)}_this3.dispatchEvent(new ErrorEvent("error",{error:error}))},onLoadPaymentData:function onLoadPaymentData(paymentData){if(_this3.onLoadPaymentData){_this3.onLoadPaymentData(paymentData)}_this3.dispatch("loadpaymentdata",paymentData)},onClick:function onClick(event){var _a;if(_this3.onClick){null===(_a=_this3.onClick)||void 0===_a?void 0:_a.call(babelHelpers.assertThisInitialized(_this3),event)}}};_this3.manager.configure(config)});return _this3}babelHelpers.createClass(GooglePayButton,[{key:"assertRequiredProperty",value:function assertRequiredProperty(name){var value=this[name];if(null===value||value===void 0){this.throwError(Error("Required property not set: ".concat(name)));return!1}return!0}/**
     * Throws an error.
     *
     * Used for testing purposes so that the method can be spied on.
     */},{key:"throwError",value:function throwError(error){throw error}},{key:"addObservedAttribute",/**
     * Registers an attribute to be observed.
     *
     * @param name Attribute name to observe.
     * @internal
     */value:function addObservedAttribute(name){GooglePayButton._observedAttributes.push(name)}},{key:"dispatch",value:function dispatch(type,detail){this.dispatchEvent(new CustomEvent(type,{bubbles:!0,cancelable:!1,detail:detail}))}},{key:"connectedCallback",value:function connectedCallback(){return __awaiter(this,void 0,void 0,/*#__PURE__*/regeneratorRuntime.mark(function _callee4(){return regeneratorRuntime.wrap(function _callee4$(_context4){while(1){switch(_context4.prev=_context4.next){case 0:_context4.next=2;return this.manager.mount(this);case 2:return _context4.abrupt("return",this.initializeButton());case 3:case"end":return _context4.stop();}}},_callee4,this)}))}},{key:"disconnectedCallback",value:function disconnectedCallback(){this.manager.unmount()}// eslint-disable-next-line @typescript-eslint/no-unused-vars
},{key:"attributeChangedCallback",value:function attributeChangedCallback(name){return this.initializeButton()}// eslint-disable-next-line @typescript-eslint/no-unused-vars
},{key:"notifyPropertyChanged",value:function notifyPropertyChanged(property){return this.initializeButton()}},{key:"isReadyToPay",get:function get(){return this.manager.isReadyToPay}}],[{key:"observedAttributes",get:function get(){return GooglePayButton._observedAttributes}}]);return GooglePayButton}(babelHelpers.wrapNativeSuper(HTMLElement));_exports.$indexDefault=GooglePayButton;GooglePayButton._observedAttributes=[];__decorate([Notify(),Alias("paymentrequest")],GooglePayButton.prototype,"paymentRequest",void 0);__decorate([NotifyAttribute()],GooglePayButton.prototype,"environment",void 0);__decorate([NotifyBooleanAttribute(),Alias("existingpaymentmethodrequired")],GooglePayButton.prototype,"existingPaymentMethodRequired",void 0);__decorate([NotifyAttribute(),Alias("buttoncolor")],GooglePayButton.prototype,"buttonColor",void 0);__decorate([NotifyAttribute(),Alias("buttontype")],GooglePayButton.prototype,"buttonType",void 0);__decorate([NotifyAttribute(),Alias("buttonsizemode")],GooglePayButton.prototype,"buttonSizeMode",void 0);__decorate([NotifyAttribute(),Alias("buttonlocale")],GooglePayButton.prototype,"buttonLocale",void 0);__decorate([Notify(),Alias("paymentDataChangedCallback"),Alias("paymentdatachangedcallback"),Alias("onpaymentdatachanged")],GooglePayButton.prototype,"onPaymentDataChanged",void 0);__decorate([Notify(),Alias("paymentAuthorizedCallback"),Alias("paymentauthorizedcallback"),Alias("onpaymentauthorized")],GooglePayButton.prototype,"onPaymentAuthorized",void 0);__decorate([Alias("readyToPayChangeCallback"),Alias("readytopaychangecallback"),Alias("onreadytopaychange")],GooglePayButton.prototype,"onReadyToPayChange",void 0);__decorate([Alias("loadPaymentDataCallback"),Alias("loadpaymentdatacallback"),Alias("onloadpaymentdata")],GooglePayButton.prototype,"onLoadPaymentData",void 0);__decorate([Alias("cancelCallback"),Alias("cancelcallback"),Alias("oncancel")],GooglePayButton.prototype,"onCancel",void 0);__decorate([Alias("errorCallback"),Alias("errorcallback"),Alias("onerror")],GooglePayButton.prototype,"onError",void 0);__decorate([Alias("clickCallback"),Alias("clickcallback"),Alias("onclick")],GooglePayButton.prototype,"onClick",void 0);customElements.define("google-pay-button",GooglePayButton);/**
                                                              * Copyright 2020 Google LLC
                                                              *
                                                              * Licensed under the Apache License, Version 2.0 (the "License");
                                                              * you may not use this file except in compliance with the License.
   ...
   */_exports.$index=index;"use strict";var nativeShadow=!(window.ShadyDOM&&window.ShadyDOM.inUse);_exports.nativeShadow=nativeShadow;var nativeCssVariables_;/**
...
if(nativeShadow){element.setAttribute("class",value)}else{window.ShadyDOM.nativeMethods.setAttribute.call(element,"class",value)}}/**
   ...
   * @return {string}
   */function gatherStyleText(element){/** @type {!Array<string>} */for(var styleTextParts=[],styles=/** @type {!NodeList<!HTMLStyleElement>} */element.querySelectorAll("style"),i=0,_style2;i<styles.length;i++){_style2=styles[i];if(isUnscopedStyle(_style2)){if(!nativeShadow){processUnscopedStyle(_style2);_style2.parentNode.removeChild(_style2)}}else{styleTextParts.push(_style2.textContent);_style2.parentNode.removeChild(_style2)}}return styleTextParts.join("").trim()}/**
...
MIXIN_MATCH.lastIndex=0;VAR_ASSIGN.lastIndex=0;return has}var commonUtils={updateNativeProperties:updateNativeProperties,getComputedStyleValue:_getComputedStyleValue,detectMixin:_detectMixin};/**
   ...
   */ /*
     ...
     * @param {!HTMLStyleElement} style
     * @return {StyleNode}
     */},{key:"transformCustomStyle",value:function transformCustomStyle(style){var _this4=this,ast=rulesForStyle(style);forEachRule(ast,function(rule){if(":root"===rule.selector){rule.selector="html"}_this4.transformRule(rule)});style.textContent=toCssText(ast);return ast}/**
     * @param {StyleNode} rules
     * @param {string} elementName
     */},{key:"transformRules",value:function transformRules(rules,elementName){var _this5=this;this._currentElement=elementName;forEachRule(rules,function(r){_this5.transformRule(r)});this._currentElement=null}/**
     * @param {!StyleNode} rule
...
if(":root"===rule.selector){rule.selector=":host > *"}}/**
     ...
     * @param {!StyleNode} rule
     * @return {string}
     */},{key:"transformCssText",value:function transformCssText(cssText,rule){var _this6=this;// produce variables
cssText=cssText.replace(VAR_ASSIGN,function(matchText,propertyName,valueProperty,valueMixin){return _this6._produceCssProperties(matchText,propertyName,valueProperty,valueMixin,rule)});// consume mixins
return this._consumeCssProperties(cssText,rule)}/**
     ...
     * @return {!Object}
     */},{key:"_fallbacksFromPreviousRules",value:function _fallbacksFromPreviousRules(startRule){var _this7=this,topRule=startRule;while(topRule.parent){topRule=topRule.parent}var fallbacks={},seenStartRule=!1;forEachRule(topRule,function(r){// stop when we hit the input rule
...
if(r.selector===startRule.selector){Object.assign(fallbacks,_this7._cssTextToMap(r.parsedCssText))}});return fallbacks}/**
...
documentWait(function(){if(window.ShadyCSS.flushCustomStyles){window.ShadyCSS.flushCustomStyles()}})}/**
     ...
     */},{key:"processStyles",value:function processStyles(){for(var cs=this.customStyles,i=0,_customStyle;i<cs.length;i++){_customStyle=cs[i];if(_customStyle[CACHED_STYLE]){continue}var _style4=this.getStyleForCustomStyle(_customStyle);if(_style4){// HTMLImports polyfill may have cloned the style into the main document,
...
var styleToTransform=/** @type {!HTMLStyleElement} */_style4.__appliedElement||_style4;if(transformFn){transformFn(styleToTransform)}_customStyle[CACHED_STYLE]=styleToTransform}}return cs}}]);return CustomStyleInterface}();_exports.$customStyleInterfaceDefault=CustomStyleInterface;/* eslint-disable no-self-assign */CustomStyleInterface.prototype.addCustomStyle=CustomStyleInterface.prototype.addCustomStyle;CustomStyleInterface.prototype.getStyleForCustomStyle=CustomStyleInterface.prototype.getStyleForCustomStyle;CustomStyleInterface.prototype.processStyles=CustomStyleInterface.prototype.processStyles;/* eslint-enable no-self-assign */Object.defineProperties(CustomStyleInterface.prototype,{transformCallback:{/** @return {?function(!HTMLStyleElement)} */get:function get(){return transformFn},/** @param {?function(!HTMLStyleElement)} fn */set:function set(fn){transformFn=fn}},validateCallback:{/** @return {?function()} */get:function get(){return validateFn},/**
   ...
   Code distributed by Google as part of the polymer project is also
   subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
   */_exports.$customStyleInterface$1=customStyleInterface;"use strict";var applyShim$1=new ApplyShim,ApplyShimInterface=/*#__PURE__*/function(){function ApplyShimInterface(){babelHelpers.classCallCheck(this,ApplyShimInterface);/** @type {?CustomStyleInterfaceInterface} */this.customStyleInterface=null;applyShim$1.invalidCallback=invalidate}babelHelpers.createClass(ApplyShimInterface,[{key:"ensure",value:function ensure(){var _this9=this;if(this.customStyleInterface){return}if(window.ShadyCSS.CustomStyleInterface){this.customStyleInterface=/** @type {!CustomStyleInterfaceInterface} */window.ShadyCSS.CustomStyleInterface;this.customStyleInterface.transformCallback=function(style){applyShim$1.transformCustomStyle(style)};this.customStyleInterface.validateCallback=function(){requestAnimationFrame(function(){if(_this9.customStyleInterface.enqueued){_this9.flushCustomStyles()}})}}}/**
     * @param {!HTMLTemplateElement} template
     * @param {string} elementName
...
if(include){styles.push.apply(styles,babelHelpers.toConsumableArray(stylesFromModules(include).filter(function(item,index,self){return self.indexOf(item)===index})))}if(baseURI){e.textContent=resolveCss(e.textContent,/** @type {string} */baseURI)}styles.push(e)}template._styles=styles}return template._styles}/**
   ...
   * @return {!Array<!HTMLStyleElement>} Array of contained styles
   */function _stylesFromModuleImports(module){for(var styles=[],p$=module.querySelectorAll(MODULE_STYLE_LINK_SELECTOR),i=0,_p5;i<p$.length;i++){_p5=p$[i];if(_p5.import){var importDoc=_p5.import,unscoped=_p5.hasAttribute(SHADY_UNSCOPED_ATTR);if(unscoped&&!importDoc._unscopedStyle){var _style7=styleForImport(importDoc);_style7.setAttribute(SHADY_UNSCOPED_ATTR,"");importDoc._unscopedStyle=_style7}else if(!importDoc._style){importDoc._style=styleForImport(importDoc)}styles.push(unscoped?importDoc._unscopedStyle:importDoc._style)}}return styles}/**
   *
...
if(!(prop in proto)){proto._createPropertyAccessor(prop)}}}/**
       ...
       * @protected
       * @nocollapse
       */},{key:"typeForProperty",value:function typeForProperty(name){}}]);function PropertiesChanged(){var _this10;babelHelpers.classCallCheck(this,PropertiesChanged);_this10=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PropertiesChanged).call(this));/** @type {boolean} */_this10.__dataEnabled=!1;_this10.__dataReady=!1;_this10.__dataInvalid=!1;_this10.__data={};_this10.__dataPending=null;_this10.__dataOld=null;_this10.__dataInstanceProps=null;/** @type {number} */ // NOTE: used to track re-entrant calls to `_flushProperties`
_this10.__dataCounter=0;_this10.__serializing=!1;_this10._initializeProperties();return _this10}/**
...
if(this.__dataOld&&!(property in this.__dataOld)){this.__dataOld[property]=old}this.__data[property]=value;this.__dataPending[property]=value}return changed}/* eslint-enable */ /**
       ...
       * @protected
       * @override
       */},{key:"_invalidateProperties",value:function _invalidateProperties(){var _this11=this;if(!this.__dataInvalid&&this.__dataReady){this.__dataInvalid=!0;microtask.run(function(){if(_this11.__dataInvalid){_this11.__dataInvalid=!1;_this11._flushProperties()}})}}/**
...
dom.__noInsertionPoint=!templateInfo.hasInsertionPoint;var nodes=dom.nodeList=Array(nodeInfo.length);dom.$={};for(var _i5=0,l=nodeInfo.length,info,node;_i5<l&&(info=nodeInfo[_i5]);_i5++){node=nodes[_i5]=findTemplateNode(dom,info);applyIdToMap(this,dom.$,node,info);applyTemplateInfo(this,node,info,templateInfo);applyEventListener(this,node,info)}dom=/** @type {!StampedTemplate} */dom;// eslint-disable-line no-self-assign
return dom}/**
 ...
 * @private
 */function ensureOwnEffectMap(model,type,cloneArrays){var effects=model[type];if(!effects){effects=model[type]={}}else if(!model.hasOwnProperty(type)){effects=model[type]=Object.create(model[type]);if(cloneArrays){for(var _p8 in effects){for(var protoFx=effects[_p8],instFx=effects[_p8]=Array(protoFx.length),_i7=0;_i7<protoFx.length;_i7++){instFx[_i7]=protoFx[_i7]}}}}return effects}// -- effects ----------------------------------------------
/**
...
var rootProperty=hasPaths?root(prop):prop,fxs=effects[rootProperty];if(fxs){for(var _i8=0,l=fxs.length,fx;_i8<l&&(fx=fxs[_i8]);_i8++){if((!fx.info||fx.info.lastRun!==id)&&(!hasPaths||pathMatchesTrigger(prop,fx.trigger))){if(fx.info){fx.info.lastRun=id}fx.fn(inst,prop,props,oldProps,fx.info,hasPaths,extraArgs);ran=!0}}}}return ran}return!1}/**
...
// the effect metadata
if(0>cmp){start=mid+1}else if(0<cmp){end=mid-1}else{idx=mid;break}}if(0>idx){idx=end+1}queue.splice(idx,0,info)},enqueueEffectsFor=function enqueueEffectsFor(prop,computeEffects,queue,order,hasPaths){var rootProperty=hasPaths?root(prop):prop,fxs=computeEffects[rootProperty];if(fxs){for(var _i10=0,fx;_i10<fxs.length;_i10++){fx=fxs[_i10];if(fx.info.lastRun!==dedupeId$1&&(!hasPaths||pathMatchesTrigger(prop,fx.trigger))){fx.info.lastRun=dedupeId$1;insertEffect(fx.info,queue,order)}}}};/**
...
for(var index=templateInfo.nodeInfoList.length,_i11=0,part;_i11<binding.parts.length;_i11++){part=binding.parts[_i11];part.compoundIndex=_i11;addEffectForBindingPart(constructor,templateInfo,binding,part,index)}}/**
...
var nodeList=templateInfo.nodeList,nodeInfoList=templateInfo.nodeInfoList;if(nodeInfoList.length){for(var _i12=0;_i12<nodeInfoList.length;_i12++){var info=nodeInfoList[_i12],node=nodeList[_i12],bindings=info.bindings;if(bindings){for(var _i13=0,binding;_i13<bindings.length;_i13++){binding=bindings[_i13];setupCompoundStorage(node,binding);addNotifyListener(node,inst,binding)}}// This ensures all bound elements have a host set, regardless
 ...
 * @private
 */function createMethodEffect(model,sig,type,effectFn,methodInfo,dynamicFn){dynamicFn=sig.static||dynamicFn&&("object"!==babelHelpers.typeof(dynamicFn)||dynamicFn[sig.methodName]);for(var info={methodName:sig.methodName,args:sig.args,methodInfo:methodInfo,dynamicFn:dynamicFn},_i14=0,arg;_i14<sig.args.length&&(arg=sig.args[_i14]);_i14++){if(!arg.literal){model._addPropertyEffect(arg.rootProperty,type,{fn:effectFn,info:info,trigger:arg})}}if(dynamicFn){model._addPropertyEffect(sig.methodName,type,{fn:effectFn,info:info})}return info}/**
...
/**
                                                   ...
                                                   */function literalFromParts(parts){for(var s="",_i15=0,literal;_i15<parts.length;_i15++){literal=parts[_i15].literal;s+=literal||""}return s}/**
...
if(legacyUndefined&&!inst._overrideLegacyUndefined){splicesData.indexSplices=[]}}/**
   ...
   * @unrestricted
   * @private
   */var propertyEffectsBase=TemplateStamp(PropertyAccessors(superClass)),PropertyEffects=/*#__PURE__*/function(_propertyEffectsBase){babelHelpers.inherits(PropertyEffects,_propertyEffectsBase);function PropertyEffects(){var _this12;babelHelpers.classCallCheck(this,PropertyEffects);_this12=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PropertyEffects).call(this));/** @type {boolean} */ // Used to identify users of this mixin, ala instanceof
_this12.__isPropertyEffectsClient=!0;/** @type {boolean} */_this12.__dataClientsReady;/** @type {Array} */_this12.__dataPendingClients;/** @type {Object} */_this12.__dataToNotify;/** @type {Object} */_this12.__dataLinkedPaths;/** @type {boolean} */_this12.__dataHasPaths;/** @type {Object} */_this12.__dataCompoundStorage;/** @type {Polymer_PropertyEffects} */_this12.__dataHost;/** @type {!Object} */_this12.__dataTemp;/** @type {boolean} */_this12.__dataClientsInitialized;/** @type {!Object} */_this12.__data;/** @type {!Object|null} */_this12.__dataPending;/** @type {!Object} */_this12.__dataOld;/** @type {Object} */_this12.__computeEffects;/** @type {Object} */_this12.__computeInfo;/** @type {Object} */_this12.__reflectEffects;/** @type {Object} */_this12.__notifyEffects;/** @type {Object} */_this12.__propagateEffects;/** @type {Object} */_this12.__observeEffects;/** @type {Object} */_this12.__readOnly;/** @type {!TemplateInfo} */_this12.__templateInfo;/** @type {boolean} */_this12._overrideLegacyUndefined;return _this12}babelHelpers.createClass(PropertyEffects,[{key:"_initializeProperties",/**
       * @override
       * @return {void}
...
// ----------------------------
       ...
       * @return {void}
       * @protected
       */},{key:"_propagatePropertyChanges",value:function _propagatePropertyChanges(changedProps,oldProps,hasPaths){if(this[TYPES.PROPAGATE]){runEffects(this,this[TYPES.PROPAGATE],changedProps,oldProps,hasPaths)}if(this.__templateInfo){this._runEffectsForTemplate(this.__templateInfo,changedProps,oldProps,hasPaths)}}},{key:"_runEffectsForTemplate",value:function _runEffectsForTemplate(templateInfo,changedProps,oldProps,hasPaths){var _this13=this,baseRunEffects=function baseRunEffects(changedProps,hasPaths){runEffects(_this13,templateInfo.propertyEffects,changedProps,oldProps,hasPaths,templateInfo.nodeList);for(var info=templateInfo.firstChild;info;info=info.nextSibling){_this13._runEffectsForTemplate(info,changedProps,oldProps,hasPaths)}};if(templateInfo.runEffects){templateInfo.runEffects(baseRunEffects,changedProps,hasPaths)}else{baseRunEffects(changedProps,hasPaths)}}/**
...
ensureOwnEffectMap(this,COMPUTE_INFO)[property]=info}/**
       ...
       * @private
       */},{key:"_marshalArgs",value:function _marshalArgs(args,path,props){for(var data=this.__data,values=[],_i17=0,l=args.length;_i17<l;_i17++){var _args$_i=args[_i17],_name=_args$_i.name,structured=_args$_i.structured,wildcard=_args$_i.wildcard,value=_args$_i.value,literal=_args$_i.literal;if(!literal){if(wildcard){var _matches=isDescendant(_name,path),pathValue=getArgValue(data,props,_matches?path:_name);value={path:_matches?path:_name,value:pathValue,base:_matches?_get(data,_name):pathValue}}else{value=structured?getArgValue(data,props,_name):data[_name]}}// When the `legacyUndefined` flag is enabled, pass a no-op value
// so that the observer, computed property, or compound binding is aborted.
if(legacyUndefined&&!this._overrideLegacyUndefined&&value===void 0&&1<args.length){return NOOP}values[_i17]=value}return values}// -- static class methods ------------
/**
...
for(var nodes=templateInfo.childNodes,_i18=0,node;_i18<nodes.length;_i18++){node=nodes[_i18];wrap$1(wrap$1(node).parentNode).removeChild(node)}}/**
...
for(var args=signature.args,methodName=signature.methodName,_i19=0,arg;_i19<args.length;_i19++){arg=args[_i19];if(!arg.literal){dependencies.push(arg)}}var dynamicFns=templateInfo.dynamicFns;if(dynamicFns&&dynamicFns[methodName]||signature.static){dependencies.push(methodName);signature.dynamicFn=!0}}else{// Property or path
...
for(var templateStyleIndex=0,_i20=0;_i20<stylesWithImports.length;_i20++){var _s=stylesWithImports[_i20],templateStyle=templateStyles[templateStyleIndex];// if the style is not in this template, it's been "included" and
...
var template=/** @type {PolymerElementConstructor} */this.template;if(template){if("string"===typeof template){console.error("template getter must return HTMLTemplateElement");template=null}else if(!legacyOptimizations){template=template.cloneNode(!0)}}/** @override */this.prototype._template=template}/**
       ...
       * @protected
       * @nocollapse
       */},{key:"createObservers",value:function createObservers(observers,dynamicFns){for(var proto=this.prototype,_i21=0;_i21<observers.length;_i21++){proto._createMethodObserver(observers[_i21],dynamicFns)}}/**
     ...
     * @nocollapse
     */get:function get(){return version$1}},{key:"template",get:function get(){// Explanation of template-related properties:
...
Object.getPrototypeOf(/** @type {PolymerElementConstructor}*/this.prototype).constructor.template}return this._template}/**
       ...
       * @nocollapse
       */},{key:"importPath",get:function get(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_importPath",this))){var meta=this.importMeta;if(meta){this._importPath=pathFromUrl(meta.url)}else{var module=DomModule.import(/** @type {PolymerElementConstructor} */this.is);this._importPath=module&&module.assetpath||Object.getPrototypeOf(/** @type {PolymerElementConstructor}*/this.prototype).constructor.importPath}}return this._importPath}}]);function PolymerElement(){var _this15;babelHelpers.classCallCheck(this,PolymerElement);_this15=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PolymerElement).call(this));/** @type {HTMLTemplateElement} */_this15._template;/** @type {string} */_this15._importPath;/** @type {string} */_this15.rootPath;/** @type {string} */_this15.importPath;/** @type {StampedTemplate | HTMLElement | ShadowRoot} */_this15.root;/** @type {!Object<string, !Element>} */_this15.$;return _this15}/**
...
return polymerElementBase._addTemplatePropertyEffect.call(this,templateInfo,prop,effect)}}]);return PolymerElement}(polymerElementBase);return PolymerElement});/**
     ...
     * @return {void}
     */_exports.ElementMixin=ElementMixin;var updateStyles=function updateStyles(props){if(window.ShadyCSS){window.ShadyCSS.styleDocument(props)}};_exports.updateStyles=updateStyles;var elementMixin={version:version$1,builtCSS:builtCSS,ElementMixin:ElementMixin,updateStyles:updateStyles};_exports.$elementMixin=elementMixin;var Debouncer=/*#__PURE__*/function(){function Debouncer(){babelHelpers.classCallCheck(this,Debouncer);this._asyncModule=null;this._callback=null;this._timer=null}/**
     ...
     * @param {function()} callback Callback to run.
     * @return {void}
     */babelHelpers.createClass(Debouncer,[{key:"setConfig",value:function setConfig(asyncModule,callback){var _this16=this;this._asyncModule=asyncModule;this._callback=callback;this._timer=this._asyncModule.run(function(){_this16._timer=null;debouncerQueue.delete(_this16);_this16._callback()})}/**
...
debouncerQueue.forEach(function(debouncer){try{debouncer.flush()}catch(e){setTimeout(function(){throw e})}});return didFlush};_exports.flushDebouncers=flushDebouncers;var debounce$1={Debouncer:Debouncer,enqueueDebouncer:enqueueDebouncer,flushDebouncers:flushDebouncers};_exports.$debounce=debounce$1;var HAS_NATIVE_TA="string"===typeof document.head.style.touchAction,GESTURE_KEY="__polymerGestures",HANDLED_OBJ="__polymerGesturesHandled",TOUCH_ACTION="__polymerGesturesTouchAction",TAP_DISTANCE=25,TRACK_DISTANCE=5,TRACK_LENGTH=2,MOUSE_TIMEOUT=2500,MOUSE_EVENTS=["mousedown","mousemove","mouseup","click"],MOUSE_WHICH_TO_BUTTONS=[0,1,4,2],MOUSE_HAS_BUTTONS=function(){try{return 1===new MouseEvent("test",{buttons:1}).buttons}catch(e){return!1}}();/**
...
if(el.id){for(var matching=_root2.querySelectorAll("label[for = ".concat(el.id,"]")),_i22=0;_i22<matching.length;_i22++){labels.push(/** @type {!HTMLLabelElement} */matching[_i22])}}}return labels}// touch will make synthetic mouse events
...
if("click"===mouseEvent.type){for(var clickFromLabel=!1,_path2=getComposedPath(mouseEvent),_i23=0;_i23<_path2.length;_i23++){if(_path2[_i23].nodeType===Node.ELEMENT_NODE){if("label"===_path2[_i23].localName){clickedLabels.push(/** @type {!HTMLLabelElement} */_path2[_i23])}else if(canBeLabelled(/** @type {!HTMLElement} */_path2[_i23])){// check if one of the clicked labels is labelling this element
for(var ownerLabels=matchingLabels(/** @type {!HTMLElement} */_path2[_i23]),j=0;j<ownerLabels.length;j++){clickFromLabel=clickFromLabel||-1<clickedLabels.indexOf(ownerLabels[j])}}}if(_path2[_i23]===POINTERSTATE.mouse.target){return}}// if one of the clicked labels was labelling the target element,
// this is not a ghost click
if(clickFromLabel){return}mouseEvent.preventDefault();mouseEvent.stopPropagation()}};/**
    * @param {boolean=} setup True to add, false to remove.
    * @return {void}
    */function setupTeardownMouseCanceller(setup){for(var events=IS_TOUCH_ONLY?["click"]:MOUSE_EVENTS,_i24=0,en;_i24<events.length;_i24++){en=events[_i24];if(setup){// reset clickLabels array
...
for(var _i26=0,r;_i26<recognizers.length;_i26++){r=recognizers[_i26];if(gs[r.name]&&!handled[r.name]){if(r.flow&&-1<r.flow.start.indexOf(ev.type)&&r.reset){r.reset()}}}// enforce gesture recognizer order
for(var _i27=0,_r;_i27<recognizers.length;_i27++){_r=recognizers[_i27];if(gs[_r.name]&&!handled[_r.name]){handled[_r.name]=!0;_r[type](ev)}}}/**
   * @private
   ...
   * @return {void}
   */function _add(node,evType,handler){var recognizer=gestures[evType],deps=recognizer.deps,name=recognizer.name,gobj=node[GESTURE_KEY];if(!gobj){node[GESTURE_KEY]=gobj={}}for(var _i28=0,dep,gd;_i28<deps.length;_i28++){dep=deps[_i28];// don't add mouse handlers on iOS because they cause gray selection overlays
if(IS_TOUCH_ONLY&&isMouseEvent(dep)&&"click"!==dep){continue}gd=gobj[dep];if(!gd){gobj[dep]=gd={_count:0}}if(0===gd._count){node.addEventListener(dep,_handleNative,PASSIVE_TOUCH(dep))}gd[name]=(gd[name]||0)+1;gd._count=(gd._count||0)+1}node.addEventListener(evType,handler);if(recognizer.touchAction){setTouchAction(node,recognizer.touchAction)}}/**
   ...
   * @return {void}
   */function _remove(node,evType,handler){var recognizer=gestures[evType],deps=recognizer.deps,name=recognizer.name,gobj=node[GESTURE_KEY];if(gobj){for(var _i29=0,dep,gd;_i29<deps.length;_i29++){dep=deps[_i29];gd=gobj[dep];if(gd&&gd[name]){gd[name]=(gd[name]||1)-1;gd._count=(gd._count||1)-1;if(0===gd._count){node.removeEventListener(dep,_handleNative,PASSIVE_TOUCH(dep))}}}}node.removeEventListener(evType,handler)}/**
   * Registers a new gesture event recognizer for adding new custom
   * gesture event types.
   *
   * @param {!GestureRecognizer} recog Gesture recognizer descriptor
   * @return {void}
   */function register$1(recog){recognizers.push(recog);for(var _i30=0;_i30<recog.emits.length;_i30++){gestures[recog.emits[_i30]]=recog}}/**
   * @private
   * @param {string} evName Event name.
   * @return {Object} Returns the gesture for the given event name.
   */function _findRecognizerByEvent(evName){for(var _i31=0,r;_i31<recognizers.length;_i31++){r=recognizers[_i31];for(var j=0,n;j<r.emits.length;j++){n=r.emits[j];if(n===evName){return r}}}return null}/**
...
if(!info.prevent){_fire(t,"tap",{x:e.clientX,y:e.clientY,sourceEvent:e,preventer:preventer})}}}/* eslint-enable valid-jsdoc */ /** @deprecated */var findOriginalTarget=_findOriginalTarget;/** @deprecated */_exports.findOriginalTarget=findOriginalTarget;var add=addListener;/** @deprecated */_exports.add=add;var remove=removeListener;_exports.remove=remove;var gestures$1={gestures:gestures,recognizers:recognizers,deepTargetFind:deepTargetFind,addListener:addListener,removeListener:removeListener,register:register$1,setTouchAction:setTouchAction,prevent:_prevent,resetMouseCanceller:resetMouseCanceller,findOriginalTarget:findOriginalTarget,add:add,remove:remove};_exports.$gestures=gestures$1;var GestureEventListeners=dedupingMixin(function(superClass){/**
   ...
   */function setRTL(instance){if(!instance.__autoDirOptOut){var el=/** @type {!HTMLElement} */instance;el.setAttribute("dir",documentDir)}}function updateDirection(){getRTL();documentDir=document.documentElement.getAttribute("dir");for(var _i32=0;_i32<DIR_INSTANCES.length;_i32++){setRTL(DIR_INSTANCES[_i32])}}function takeRecords(){if(observer&&observer.takeRecords().length){updateDirection()}}/**
...
setTimeout(function(){runQueue(afterRenderQueue)})})}function flushQueue(queue){while(queue.length){callMethod(queue.shift())}}function runQueue(queue){for(var _i33=0,l=queue.length;_i33<l;_i33++){callMethod(queue.shift())}}function callMethod(info){var context=info[0],callback=info[1],args=info[2];try{callback.apply(context,args)}catch(e){setTimeout(function(){throw e})}}/**
...
for(var rowCount=oldEnd-oldStart+1,columnCount=currentEnd-currentStart+1,distances=Array(rowCount),_i34=0;_i34<rowCount;_i34++){distances[_i34]=Array(columnCount);distances[_i34][0]=_i34}// Initialize null row
for(var j=0;j<columnCount;j++){distances[0][j]=j}for(var _i35=1;_i35<rowCount;_i35++){for(var _j=1;_j<columnCount;_j++){if(equals(current[currentStart+_j-1],old[oldStart+_i35-1]))distances[_i35][_j]=distances[_i35-1][_j-1];else{var north=distances[_i35-1][_j]+1,west=distances[_i35][_j-1]+1;distances[_i35][_j]=north<west?north:west}}}return distances}// This starts at the final weight, and walks "backward" by finding
...
return wrap$1(node).assignedNodes({flatten:!0})}else{return[node]}}).reduce(function(a,b){return a.concat(b)},[])}}/**
     ...
     */ // eslint-disable-next-line
}]);function FlattenedNodesObserver(target,callback){var _this18=this;babelHelpers.classCallCheck(this,FlattenedNodesObserver);/**
     ...
     */this._shadyChildrenObserver=null;/**
                              ...
                              * @type {function()}
                              * @private
                              */this._boundSchedule=function(){_this18._schedule()};this.connect();this._schedule()}/**
     * Activates an observer. This method is automatically called when
     * a `FlattenedNodesObserver` is created. It should only be called to
     * re-activate an observer that has been deactivated via the `disconnect` method.
     *
     * @return {void}
     */babelHelpers.createClass(FlattenedNodesObserver,[{key:"connect",value:function connect(){var _this19=this;if(isSlot(this._target)){this._listenSlots([this._target])}else if(wrap$1(this._target).children){this._listenSlots(/** @type {!NodeList<!Node>} */wrap$1(this._target).children);if(window.ShadyDOM){this._shadyChildrenObserver=window.ShadyDOM.observeChildren(this._target,function(mutations){_this19._processMutations(mutations)})}else{this._nativeChildrenObserver=new MutationObserver(function(mutations){_this19._processMutations(mutations)});this._nativeChildrenObserver.observe(this._target,{childList:!0})}}this._connected=!0}/**
     ...
     * @return {void}
     * @private
     */},{key:"_schedule",value:function _schedule(){var _this20=this;if(!this._scheduled){this._scheduled=!0;microTask.run(function(){return _this20.flush()})}}/**
     ...
     * @return {void}
     * @private
     */},{key:"_processSlotMutations",value:function _processSlotMutations(mutations){if(mutations){for(var _i38=0,mutation;_i38<mutations.length;_i38++){mutation=mutations[_i38];if(mutation.addedNodes){this._listenSlots(mutation.addedNodes)}if(mutation.removedNodes){this._unlistenSlots(mutation.removedNodes)}}}}/**
...
for(var info={target:this._target,addedNodes:[],removedNodes:[]},newNodes=this.constructor.getFlattenedNodes(this._target),splices=calculateSplices(newNodes,this._effectiveNodes),_i39=0,s;_i39<splices.length&&(s=splices[_i39]);_i39++){for(var j=0,n;j<s.removed.length&&(n=s.removed[j]);j++){info.removedNodes.push(n)}}// process adds
for(var _i40=0,_s2;_i40<splices.length&&(_s2=splices[_i40]);_i40++){for(var _j2=_s2.index;_j2<_s2.index+_s2.addedCount;_j2++){info.addedNodes.push(newNodes[_j2])}}// update cache
...
n=wrap$1(n).parentNode||wrap$1(n).host}return n===this.node}/**
     ...
     * @override
     */},{key:"queryDistributedElements",value:function queryDistributedElements(selector){for(var c$=this.getEffectiveChildNodes(),list=[],_i43=0,l=c$.length,c;_i43<l&&(c=c$[_i43]);_i43++){if(c.nodeType===Node.ELEMENT_NODE&&matchesSelector(c,selector)){list.push(c)}}return list}/**
     * For shadow roots, returns the currently focused element within this
     * shadow root.
     *
     * return {Node|undefined} Currently focused element
     * @override
     */},{key:"activeElement",get:function get(){var node=this.node;return node._activeElement!==void 0?node._activeElement:node.activeElement}}]);return DomApiNative}();function forwardMethods(proto,methods){for(var _loop=function _loop(_i44){var method=methods[_i44];/* eslint-disable valid-jsdoc */proto[method]=/** @this {DomApiNative} */function(){return this.node[method].apply(this.node,arguments)};/* eslint-enable */},_i44=0;_i44<methods.length;_i44++){_loop(_i44)}}function forwardReadOnlyProperties(proto,properties){for(var _loop2=function _loop2(_i45){var name=properties[_i45];Object.defineProperty(proto,name,{get:function get(){var domApi=/** @type {DomApiNative} */this;return domApi.node[name]},configurable:!0})},_i45=0;_i45<properties.length;_i45++){_loop2(_i45)}}function forwardProperties(proto,properties){for(var _loop3=function _loop3(_i46){var name=properties[_i46];Object.defineProperty(proto,name,{/**
       * @this {DomApiNative}
       * @return {*} .
       */get:function get(){return this.node[name]},/**
       * @this {DomApiNative}
       * @param {*} value .
       */set:function set(value){this.node[name]=value},configurable:!0})},_i46=0;_i46<properties.length;_i46++){_loop3(_i46)}}/**
...
// path.
localTarget:{get:function get(){for(var current=this.event.currentTarget,currentRoot=current&&dom(current).getOwnerRoot(),p$=this.path,_i47=0,e;_i47<p$.length;_i47++){e=p$[_i47];if(dom(e).getOwnerRoot()===currentRoot){return e}}},configurable:!0},path:{get:function get(){return window.ShadyDOM.composedPath(this.event)},configurable:!0}})}else{// Methods that can provoke distribution or must return the logical, not
// composed tree.
...
scopify(container);if(shouldObserve){var mo=new MutationObserver(function(mxns){for(var _i49=0,mxn;_i49<mxns.length;_i49++){mxn=mxns[_i49];for(var j=0,addedNode;j<mxn.addedNodes.length;j++){addedNode=mxn.addedNodes[j];if(addedNode.nodeType===Node.ELEMENT_NODE){scopify(addedNode)}}}});mo.observe(container,{childList:!0,subtree:!0});return mo}else{return null}}var scopeSubtree$1={scopeSubtree:_scopeSubtree};_exports.$scopeSubtree=scopeSubtree$1;var DISABLED_ATTR="disable-upgrade",findObservedAttributesGetter=function findObservedAttributesGetter(ctor){while(ctor){var desc=Object.getOwnPropertyDescriptor(ctor,"observedAttributes");if(desc){return desc.get}ctor=Object.getPrototypeOf(ctor.prototype).constructor}return function(){return[]}};_exports.findObservedAttributesGetter=findObservedAttributesGetter;/**
   ...
   * @extends {HTMLElement}
   * @private
   */var superClass=ElementMixin(base),observedAttributesGetter=findObservedAttributesGetter(superClass),DisableUpgradeClass=/*#__PURE__*/function(_superClass4){babelHelpers.inherits(DisableUpgradeClass,_superClass4);function DisableUpgradeClass(){var _this21;babelHelpers.classCallCheck(this,DisableUpgradeClass);_this21=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(DisableUpgradeClass).call(this));/** @type {boolean|undefined} */_this21.__isUpgradeDisabled;return _this21}babelHelpers.createClass(DisableUpgradeClass,[{key:"_initializeProperties",// Prevent element from initializing properties when it's upgrade disabled.
...
return DisableUpgradeClass});_exports.DisableUpgradeMixin=DisableUpgradeMixin;var disableUpgradeMixin={findObservedAttributesGetter:findObservedAttributesGetter,DisableUpgradeMixin:DisableUpgradeMixin};_exports.$disableUpgradeMixin=disableUpgradeMixin;var bundledImportMeta$1=_objectSpread({},meta,{url:new URL("../node_assets/%40polymer/polymer/lib/legacy/legacy-element-mixin.js",meta.url).href}),DISABLED_ATTR$1="disable-upgrade",styleInterface=window.ShadyCSS,LegacyElementMixin=dedupingMixin(function(base){// TODO(kschaaf): Note, the `@implements {Polymer_DirMixin}` is required here
...
/**
   ...
   * @extends {HTMLElement}
   * @private
   */var GesturesElement=GestureEventListeners(ElementMixin(base)),legacyElementBase=builtCSS?GesturesElement:DirMixin(GesturesElement),observedAttributesGetter=findObservedAttributesGetter(legacyElementBase),DIRECTION_MAP={x:"pan-x",y:"pan-y",none:"none",all:"auto"},LegacyElement=/*#__PURE__*/function(_legacyElementBase){babelHelpers.inherits(LegacyElement,_legacyElementBase);function LegacyElement(){var _this22;babelHelpers.classCallCheck(this,LegacyElement);_this22=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(LegacyElement).call(this));/** @type {boolean} */_this22.isAttached;/** @type {?WeakMap<!Element, !Object<string, !Function>>} */_this22.__boundListeners;/** @type {?Object<string, ?Function>} */_this22._debouncers;// NOTE: Inlined for perf from version of DisableUpgradeMixin.
/** @type {boolean|undefined} */_this22.__isUpgradeDisabled;/** @type {boolean|undefined} */_this22.__needsAttributesAtConnected;/** @type {boolean|undefined} */_this22._legacyForceObservedAttributes;return _this22}/**
...
this._applyListeners()}}},{key:"_takeAttributes",value:function _takeAttributes(){for(var a=this.attributes,_i50=0,l=a.length,_attr;_i50<l;_i50++){_attr=a[_i50];this.__attributeReaction(_attr.name,null,_attr.value)}}/**
       ...
       * @override
       */},{key:"extend",value:function extend(prototype,api){if(!(prototype&&api)){return prototype||api}for(var n$=Object.getOwnPropertyNames(api),_i51=0,n,pd;_i51<n$.length&&(n=n$[_i51]);_i51++){pd=Object.getOwnPropertyDescriptor(api,n);if(pd){Object.defineProperty(prototype,n,pd)}}return prototype}/**
       ...
       * @override
       */},{key:"mixin",value:function mixin(target,source){for(var _i52 in source){target[_i52]=source[_i52]}return target}/**
...
return this.root.querySelector(slctr)}/**
       ...
       * @override
       */},{key:"getEffectiveTextContent",value:function getEffectiveTextContent(){for(var cn=this.getEffectiveChildNodes(),tc=[],_i53=0,c;c=cn[_i53];_i53++){if(c.nodeType!==Node.COMMENT_NODE){tc.push(c.textContent)}}return tc.join("")}/**
...
// (again same as 1.x)
function applyBehaviors(proto,behaviors,lifecycle){for(var _i55=0;_i55<behaviors.length;_i55++){applyInfo(proto,behaviors[_i55],lifecycle,excludeOnBehaviors)}}function applyInfo(proto,info,lifecycle,excludeProps){copyProperties(info,proto,excludeProps);for(var _p17 in lifecycleProps){if(info[_p17]){lifecycle[_p17]=lifecycle[_p17]||[];lifecycle[_p17].push(info[_p17])}}}/**
   * @param {Array} behaviors List of behaviors to flatten.
   * @param {Array=} list Target list to flatten behaviors into.
   * @param {Array=} exclude List of behaviors to exclude from the list.
   * @return {!Array} Returns the list of flattened behaviors.
   */function flattenBehaviors(behaviors,list,exclude){list=list||[];for(var _i56=behaviors.length-1,b;0<=_i56;_i56--){b=behaviors[_i56];if(b){if(Array.isArray(b)){flattenBehaviors(b,list)}else{// dedup
...
var behaviorList,lifecycle={},PolymerGenerated=/*#__PURE__*/function(_Base){babelHelpers.inherits(PolymerGenerated,_Base);function PolymerGenerated(){babelHelpers.classCallCheck(this,PolymerGenerated);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(PolymerGenerated).apply(this,arguments))}babelHelpers.createClass(PolymerGenerated,[{key:"created",/**
       * @return {void}
       */value:function created(){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"created",this).call(this);var list=lifecycle.created;if(list){for(var _i57=0;_i57<list.length;_i57++){list[_i57].call(this)}}}/**
       * @return {void}
...
var _proto2=Object.getPrototypeOf(this),list=lifecycle.beforeRegister;if(list){for(var _i58=0;_i58<list.length;_i58++){list[_i58].call(_proto2)}}list=lifecycle.registered;if(list){for(var _i59=0;_i59<list.length;_i59++){list[_i59].call(_proto2)}}}}/**
       * @return {void}
       */},{key:"_applyListeners",value:function _applyListeners(){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"_applyListeners",this).call(this);var list=lifecycle.listeners;if(list){for(var _i60=0,listeners;_i60<list.length;_i60++){listeners=list[_i60];if(listeners){for(var l in listeners){this._addMethodEventListenerToNode(this,l,listeners[l])}}}}}// note: exception to "super then me" rule;
// do work before calling super so that super attributes
// only apply if not already set.
/**
     * @return {void}
     */},{key:"_ensureAttributes",value:function _ensureAttributes(){var list=lifecycle.hostAttributes;if(list){for(var _i61=list.length-1,hostAttributes;0<=_i61;_i61--){hostAttributes=list[_i61];for(var a in hostAttributes){this._ensureAttribute(a,hostAttributes[a])}}}babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"_ensureAttributes",this).call(this)}/**
       * @return {void}
       */},{key:"ready",value:function ready(){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"ready",this).call(this);var list=lifecycle.ready;if(list){for(var _i62=0;_i62<list.length;_i62++){list[_i62].call(this)}}}/**
       * @return {void}
       */},{key:"attached",value:function attached(){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"attached",this).call(this);var list=lifecycle.attached;if(list){for(var _i63=0;_i63<list.length;_i63++){list[_i63].call(this)}}}/**
       * @return {void}
       */},{key:"detached",value:function detached(){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"detached",this).call(this);var list=lifecycle.detached;if(list){for(var _i64=0;_i64<list.length;_i64++){list[_i64].call(this)}}}/**
       * Implements native Custom Elements `attributeChangedCallback` to
       * set an attribute value to a property via `_attributeToProperty`.
       *
       * @param {string} name Name of attribute that changed
       ...
       * @param {?string} value New attribute value
       * @return {void}
       */},{key:"attributeChanged",value:function attributeChanged(name,old,value){babelHelpers.get(babelHelpers.getPrototypeOf(PolymerGenerated.prototype),"attributeChanged",this).call(this);var list=lifecycle.attributeChanged;if(list){for(var _i65=0;_i65<list.length;_i65++){list[_i65].call(this,name,old,value)}}}}],[{key:"_finalizeClass",// explicitly not calling super._finalizeClass
...
if(behaviorList){for(var _i66=0,b;_i66<behaviorList.length;_i66++){b=behaviorList[_i66];if(b.properties){this.createProperties(b.properties)}if(b.observers){this.createObservers(b.observers,b.properties)}}}if(info.properties){this.createProperties(info.properties)}if(info.observers){this.createObservers(info.observers,info.properties)}// make sure to prepare the element template
this._prepareTemplate()}}/** @nocollapse */},{key:"properties",get:function get(){var properties={};if(behaviorList){for(var _i67=0;_i67<behaviorList.length;_i67++){mergeProperties(properties,behaviorList[_i67].properties)}}mergeProperties(properties,info.properties);return properties}/** @nocollapse */},{key:"observers",get:function get(){var observers=[];if(behaviorList){for(var _i68=0,b;_i68<behaviorList.length;_i68++){b=behaviorList[_i68];if(b.observers){observers=observers.concat(b.observers)}}}if(info.observers){observers=observers.concat(info.observers)}return observers}}]);return PolymerGenerated}(Base);// apply behaviors, note actual copying is done lazily at first instance creation
...
function upgradeTemplate(template,constructor){newInstance=template;Object.setPrototypeOf(template,constructor.prototype);new constructor;newInstance=null}/**
   ...
   * @implements {Polymer_PropertyEffects}
   * @private
   */var templateInstanceBase=PropertyEffects(/*#__PURE__*/function(){function _class2(){babelHelpers.classCallCheck(this,_class2)}return _class2}());function showHideChildren(hide,children){for(var _i69=0,n;_i69<children.length;_i69++){n=children[_i69];// Ignore non-changes
...
if(n.nodeType===Node.TEXT_NODE){if(hide){n.__polymerTextContent__=n.textContent;n.textContent=""}else{n.textContent=n.__polymerTextContent__}// remove and replace slot
   ...
   * @appliesMixin PropertyEffects
   * @unrestricted
   */var TemplateInstanceBase=/*#__PURE__*/function(_templateInstanceBase){babelHelpers.inherits(TemplateInstanceBase,_templateInstanceBase);function TemplateInstanceBase(props){var _this23;babelHelpers.classCallCheck(this,TemplateInstanceBase);_this23=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(TemplateInstanceBase).call(this));_this23._configureProperties(props);/** @type {!StampedTemplate} */_this23.root=_this23._stampTemplate(_this23.__dataHost);// Save list of stamped children
var children=[];/** @suppress {invalidCasts} */_this23.children=/** @type {!NodeList} */children;// Polymer 1.x did not use `Polymer.dom` here so not bothering.
for(var n=_this23.root.firstChild;n;n=n.nextSibling){children.push(n);n.__templatizeInstance=babelHelpers.assertThisInitialized(_this23)}if(_this23.__templatizeOwner&&_this23.__templatizeOwner.__hideTemplateChildren__){_this23._showHideChildren(!0)}// Flush props only when props are passed if instance props exist
// or when there isn't instance props.
var options=_this23.__templatizeOptions;if(props&&options.instanceProps||!options.instanceProps){_this23._enableProperties()}return _this23}/**
...
for(var iprop in props){this._setPendingProperty(iprop,props[iprop])}}/**
     ...
     * @param {function(!Event):void} handler Listener function to add
     * @return {void}
     */},{key:"_addEventListenerToNode",value:function _addEventListenerToNode(node,eventName,handler){var _this24=this;if(this._methodHost&&this.__templatizeOptions.parentModel){// If this instance should be considered a parent model, decorate
// events this template instance as `model`
this._methodHost._addEventListenerToNode(node,eventName,function(e){e.model=_this24;handler(e)})}else{// Otherwise delegate to the template's host (which could be)
 ...
 */_exports.Templatizer=Templatizer;var templatizerBehavior={Templatizer:Templatizer};_exports.$templatizerBehavior=templatizerBehavior;var elementsHidden=!1;/**
                             ...
                             */function hideElementsGlobally(){if(legacyOptimizations&&!useShadow){if(!elementsHidden){elementsHidden=!0;var _style8=document.createElement("style");_style8.textContent="dom-bind,dom-if,dom-repeat{display:none;}";document.head.appendChild(_style8)}return!0}return!1}var hideTemplateControls={hideElementsGlobally:hideElementsGlobally};_exports.$hideTemplateControls=hideTemplateControls;var domBindBase=GestureEventListeners(OptionalMutableData(PropertyEffects(HTMLElement))),DomBind=/*#__PURE__*/function(_domBindBase){babelHelpers.inherits(DomBind,_domBindBase);babelHelpers.createClass(DomBind,null,[{key:"observedAttributes",get:function get(){return["mutable-data"]}}]);function DomBind(){var _this25;babelHelpers.classCallCheck(this,DomBind);_this25=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(DomBind).call(this));if(strictTemplatePolicy){throw new Error("strictTemplatePolicy: dom-bind not allowed")}_this25.root=null;_this25.$=null;_this25.__children=null;return _this25}/* eslint-disable no-unused-vars */ /**
                                         * @override
                                         * @param {string} name Name of attribute that changed
                                         * @param {?string} old Old attribute value
                                         * @param {?string} value New attribute value
...
this.mutableData=!0}/**
     ...
     * @override
     * @return {void}
     */},{key:"disconnectedCallback",value:function disconnectedCallback(){this.__removeChildren()}},{key:"__insertChildren",value:function __insertChildren(){wrap$1(wrap$1(this).parentNode).insertBefore(this.root,this)}},{key:"__removeChildren",value:function __removeChildren(){if(this.__children){for(var _i71=0;_i71<this.__children.length;_i71++){this.root.appendChild(this.__children[_i71])}}}/**
     * Forces the element to render its content. This is typically only
     * necessary to call if HTMLImports with the async attribute are used.
     * @return {void}
     */},{key:"render",value:function render(){var _this26=this,template;if(!this.__children){template=/** @type {?HTMLTemplateElement} */template||this.querySelector("template");if(!template){// Wait until childList changes and template should be there by then
var _observer=new MutationObserver(function(){template=/** @type {HTMLTemplateElement} */_this26.querySelector("template");if(template){_observer.disconnect();_this26.render()}else{throw new Error("dom-bind requires a <template> child")}});_observer.observe(this,{childList:!0});return}this.root=this._stampTemplate(/** @type {!HTMLTemplateElement} */template);this.$=this.root.$;this.__children=[];for(var n=this.root.firstChild;n;n=n.nextSibling){this.__children[this.__children.length]=n}this._enableProperties()}this.__insertChildren();this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0}))}}]);return DomBind}(domBindBase);/**
...
get:function get(){return"dom-repeat"}},{key:"template",get:function get(){return null}},{key:"properties",get:function get(){/**
     ...
     */return{/**
       ...
       */reuseChunkedInstances:{type:Boolean}}}},{key:"observers",get:function get(){return["__itemsChanged(items.*)"]}}]);function DomRepeat(){var _this27;babelHelpers.classCallCheck(this,DomRepeat);_this27=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(DomRepeat).call(this));_this27.__instances=[];_this27.__renderDebouncer=null;_this27.__itemsIdxToInstIdx={};_this27.__chunkCount=null;_this27.__renderStartTime=null;_this27.__itemsArrayChanged=!1;_this27.__shouldMeasureChunk=!1;_this27.__shouldContinueChunking=!1;_this27.__chunkingId=0;_this27.__sortFn=null;_this27.__filterFn=null;_this27.__observePaths=null;/** @type {?function(new:TemplateInstanceBase, Object=)} */_this27.__ctor=null;_this27.__isDetached=!0;_this27.template=null;/** @type {TemplateInfo} */_this27._templateInfo;return _this27}/**
     * @override
     * @return {void}
     */babelHelpers.createClass(DomRepeat,[{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(DomRepeat.prototype),"disconnectedCallback",this).call(this);this.__isDetached=!0;for(var _i72=0;_i72<this.__instances.length;_i72++){this.__detachInstance(_i72)}}/**
     * @override
     * @return {void}
...
if(this.__isDetached){this.__isDetached=!1;for(var wrappedParent=wrap$1(wrap$1(this).parentNode),_i73=0;_i73<this.__instances.length;_i73++){this.__attachInstance(_i73,wrappedParent)}}}},{key:"__ensureTemplatized",value:function __ensureTemplatized(){var _this28=this;// Templatizing (generating the instance constructor) needs to wait
...
var _observer2=new MutationObserver(function(){if(_this28.querySelector("template")){_observer2.disconnect();_this28.__render()}else{throw new Error("dom-repeat requires a <template> child")}});_observer2.observe(this,{childList:!0});return!1}// Template instance props that should be excluded from forwarding
var instanceProps={};instanceProps[this.as]=!0;instanceProps[this.indexAs]=!0;instanceProps[this.itemsIndexAs]=!0;this.__ctor=_templatize(_template3,this,{mutableData:this.mutableData,parentModel:!0,instanceProps:instanceProps,/**
         ...
         */forwardHostProp:function forwardHostProp(prop,value){for(var i$=this.__instances,_i74=0,inst;_i74<i$.length&&(inst=i$[_i74]);_i74++){inst.forwardHostProp(prop,value)}},/**
         * @this {DomRepeat}
...
for(var paths=this.__observePaths,_i75=0;_i75<paths.length;_i75++){if(0===path.indexOf(paths[_i75])){this.__debounceRender(this.__render,this.delay)}}}}}},{key:"__itemsChanged",value:function __itemsChanged(change){if(this.items&&!Array.isArray(this.items)){console.warn("dom-repeat expected array for `items`, found",this.items)}// If path was to an item (e.g. 'items.3' or 'items.3.foo'), forward the
...
this.__debounceRender(this.__render);flush$1()}},{key:"__render",value:function __render(){var _this29=this;if(!this.__ensureTemplatized()){// No template found yet
...
if(this.initialCount&&(this.__shouldMeasureChunk||this.__shouldContinueChunking)){cancelAnimationFrame(this.__chunkingId);this.__chunkingId=requestAnimationFrame(function(){return _this29.__continueChunking()})}// Set rendered item count
this._setRenderedItemCount(this.__instances.length);// Notify users
if(!suppressTemplateNotifications||this.notifyDomChange){this.dispatchEvent(new CustomEvent("dom-change",{bubbles:!0,composed:!0}))}}},{key:"__sortAndFilterItems",value:function __sortAndFilterItems(items){for(var _this30=this,isntIdxToItemsIdx=Array(items.length),_i76=0;_i76<items.length;_i76++){isntIdxToItemsIdx[_i76]=_i76}// Apply user filter
if(this.__filterFn){isntIdxToItemsIdx=isntIdxToItemsIdx.filter(function(i,idx,array){return _this30.__filterFn(items[i],idx,array)})}// Apply user sort
if(this.__sortFn){isntIdxToItemsIdx.sort(function(a,b){return _this30.__sortFn(items[a],items[b])})}return isntIdxToItemsIdx}},{key:"__calculateLimit",value:function __calculateLimit(filteredItemCount){var limit=filteredItemCount,currentCount=this.__instances.length;// When chunking, we increase the limit from the currently rendered count
...
for(var _i77=this.__instances.length-1;_i77>=instIdx;_i77--){this.__detachAndRemoveInstance(_i77)}}},{key:"__detachInstance",value:function __detachInstance(idx){for(var inst=this.__instances[idx],wrappedRoot=wrap$1(inst.root),_i78=0,el;_i78<inst.children.length;_i78++){el=inst.children[_i78];wrappedRoot.appendChild(el)}return inst}},{key:"__attachInstance",value:function __attachInstance(idx,parent){var inst=this.__instances[idx];// Note, this is pre-wrapped as an optimization
...
/**
   ...
   * @return {void}
   * @protected
   */},{key:"_showHideChildren",value:function _showHideChildren(hidden){for(var _i79=0;_i79<this.__instances.length;_i79++){this.__instances[_i79]._showHideChildren(hidden)}}// Called as a side effect of a host items.<key>.<path> path change,
...
get:function get(){return"dom-if"}},{key:"template",get:function get(){return null}},{key:"properties",get:function get(){return{/**
       ...
       * `notifyDomChange: true` will enable firing `dom-change` events on this
       * element.
       */notifyDomChange:{type:Boolean}}}}]);function DomIfBase(){var _this31;babelHelpers.classCallCheck(this,DomIfBase);_this31=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(DomIfBase).call(this));_this31.__renderDebouncer=null;_this31._lastIf=!1;_this31.__hideTemplateChildren__=!1;/** @type {!HTMLTemplateElement|undefined} */_this31.__template;/** @type {!TemplateInfo|undefined} */_this31._templateInfo;return _this31}babelHelpers.createClass(DomIfBase,[{key:"__debounceRender",value:function __debounceRender(){var _this32=this;// Render is async for 2 reasons:
...
this.__renderDebouncer=Debouncer.debounce(this.__renderDebouncer,microTask,function(){return _this32.__render()});enqueueDebouncer(this.__renderDebouncer)}/**
     * @override
     * @return {void}
     ...
     */},{key:"__ensureTemplate",value:function __ensureTemplate(){var _this33=this;if(!this.__template){// When `removeNestedTemplates` is true, the "template" is the element
// itself, which has been given a `_templateInfo` property
...
var _observer3=new MutationObserver(function(){if(wrap$1(_this33).querySelector("template")){_observer3.disconnect();_this33.__render()}else{throw new Error("dom-if requires a <template> child")}});_observer3.observe(this,{childList:!0});return!1}this.__template=_template4}return!0}/**
...
var lastChild=wrap$1(this).previousSibling;if(lastChild!==_children[_children.length-1]){for(var _i80=0,n;_i80<_children.length&&(n=_children[_i80]);_i80++){wrap$1(parentNode).insertBefore(n,this)}}}}return!0}/**
     * Forces the element to render its content. Normally rendering is
     * asynchronous to a provoking change. This is done for efficiency so
     * that multiple changes trigger only a single render. The render method
     * should be called if, for example, template rendering is required to
...
/**
   ...
   */},{key:"__teardownInstance",value:function __teardownInstance(){}/**
                           ...
                           * @protected
                           * @return {void}
                           */},{key:"_showHideChildren",value:function _showHideChildren(){}/* eslint-enable valid-jsdoc */}]);return DomIfBase}(PolymerElement),DomIfFast=/*#__PURE__*/function(_DomIfBase){babelHelpers.inherits(DomIfFast,_DomIfBase);function DomIfFast(){var _this34;babelHelpers.classCallCheck(this,DomIfFast);_this34=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(DomIfFast).call(this));_this34.__instance=null;_this34.__syncInfo=null;return _this34}/**
     ...
     * @param {Node} parentNode The parent node to insert the instance into
     * @return {void}
     */},{key:"__createAndInsertInstance",value:function __createAndInsertInstance(parentNode){var _this35=this,host=this.__dataHost||this;if(strictTemplatePolicy){if(!this.__dataHost){throw new Error("strictTemplatePolicy: template owner not trusted")}}// Pre-bind and link the template into the effects system
...
templateInfo.runEffects=function(runEffects,changedProps,hasPaths){var syncInfo=_this35.__syncInfo;if(_this35.if){// Mix any props that changed while the `if` was false into `changedProps`
...
_this35.__syncInfo=null;_this35._showHideChildren();changedProps=Object.assign(syncInfo.changedProps,changedProps)}runEffects(changedProps,hasPaths)}else{// Accumulate any values changed while `if` was false, along with the
// runEffects method to sync them, so that we can replay them once `if`
// becomes true
if(_this35.__instance){if(!syncInfo){syncInfo=_this35.__syncInfo={runEffects:runEffects,changedProps:{}}}if(hasPaths){// Store root object of any paths; this will ensure direct bindings
...
// __invalidProps.
for(var _p19 in changedProps){var rootProp=root(_p19);syncInfo.changedProps[rootProp]=_this35.__dataHost[rootProp]}}else{Object.assign(syncInfo.changedProps,changedProps)}}}};// Stamp the template, and set its DocumentFragment to the "instance"
this.__instance=host._stampTemplate(/** @type {!HTMLTemplateElement} */this.__template,templateInfo);wrap$1(parentNode).insertBefore(this.__instance,this)}/**
     ...
     * @protected
     * @suppress {visibility}
     */},{key:"_showHideChildren",value:function _showHideChildren(){var hidden=this.__hideTemplateChildren__||!this.if;if(this.__instance&&!!this.__instance.__hidden!==hidden){this.__instance.__hidden=hidden;showHideChildren(hidden,this.__instance.templateInfo.childNodes)}if(!hidden){this.__syncHostProperties()}}}]);return DomIfFast}(DomIfBase),DomIfLegacy=/*#__PURE__*/function(_DomIfBase2){babelHelpers.inherits(DomIfLegacy,_DomIfBase2);function DomIfLegacy(){var _this36;babelHelpers.classCallCheck(this,DomIfLegacy);_this36=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(DomIfLegacy).call(this));_this36.__ctor=null;_this36.__instance=null;_this36.__invalidProps=null;return _this36}/**
     * Implementation of abstract API needed by DomIfBase.
     *
     * @override
     * @return {boolean} True when an instance has been created.
...
if(parent){parent=wrap$1(parent);for(var _i81=0,n;_i81<c$.length&&(n=c$[_i81]);_i81++){parent.removeChild(n)}}}this.__invalidProps=null;this.__instance=null}}/**
   ...
   */var elementBase=ElementMixin(superClass),ArraySelectorMixin=/*#__PURE__*/function(_elementBase2){babelHelpers.inherits(ArraySelectorMixin,_elementBase2);babelHelpers.createClass(ArraySelectorMixin,null,[{key:"properties",get:function get(){return{/**
         ...
         */toggle:{type:Boolean,value:!1}}}},{key:"observers",get:function get(){return["__updateSelection(multi, items.*)"]}}]);function ArraySelectorMixin(){var _this37;babelHelpers.classCallCheck(this,ArraySelectorMixin);_this37=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ArraySelectorMixin).call(this));_this37.__lastItems=null;_this37.__lastMulti=null;_this37.__selectedMap=null;return _this37}babelHelpers.createClass(ArraySelectorMixin,[{key:"__updateSelection",value:function __updateSelection(multi,itemsInfo){var path=itemsInfo.path;if(path==JSCompiler_renameProperty("items",this)){// Case 1 - items array changed, so diff against previous array and
...
for(var _this38=this,selected=this.__selectedMap,_loop4=function _loop4(_i82){var s=splices[_i82];selected.forEach(function(idx,item){if(idx<s.index){// no change
}else if(idx>=s.index+s.removed.length){// adjust index
selected.set(item,idx+s.addedCount-s.removed.length)}else{// remove index
selected.set(item,-1)}});for(var j=0,idx;j<s.addedCount;j++){idx=s.index+j;if(selected.has(_this38.items[idx])){selected.set(_this38.items[idx],idx)}}},_i82=0;_i82<splices.length;_i82++){_loop4(_i82)}// Update linked paths
this.__updateLinks();// Remove selected items that were removed from the items array
var sidx=0;selected.forEach(function(idx,item){if(0>idx){if(_this38.multi){_this38.splice(JSCompiler_renameProperty("selected",_this38),sidx,1)}else{_this38.selected=_this38.selectedItem=null}selected.delete(item)}else{sidx++}})}},{key:"__updateLinks",value:function __updateLinks(){var _this39=this;this.__dataLinkedPaths={};if(this.multi){var sidx=0;this.__selectedMap.forEach(function(idx){if(0<=idx){_this39.linkPaths("".concat(JSCompiler_renameProperty("items",_this39),".").concat(idx),"".concat(JSCompiler_renameProperty("selected",_this39),".").concat(sidx++))}})}else{this.__selectedMap.forEach(function(idx){_this39.linkPaths(JSCompiler_renameProperty("selected",_this39),"".concat(JSCompiler_renameProperty("items",_this39),".").concat(idx));_this39.linkPaths(JSCompiler_renameProperty("selectedItem",_this39),"".concat(JSCompiler_renameProperty("items",_this39),".").concat(idx))})}}/**
...
customStyleInterface$1.processStyles()},/**
     ...
     * @param {string} property
     * @return {string}
     */getComputedStyleValue:function getComputedStyleValue(element,property){return _getComputedStyleValue(element,property)},flushCustomStyles:function flushCustomStyles(){},nativeCss:nativeCssVariables,nativeShadow:nativeShadow,cssBuild:cssBuild,disableRuntime:disableRuntime}}window.ShadyCSS.CustomStyleInterface=customStyleInterface$1;var attr="include",CustomStyleInterface$1=window.ShadyCSS.CustomStyleInterface,CustomStyle=/*#__PURE__*/function(_HTMLElement3){babelHelpers.inherits(CustomStyle,_HTMLElement3);function CustomStyle(){var _this41;babelHelpers.classCallCheck(this,CustomStyle);_this41=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(CustomStyle).call(this));_this41._style=null;CustomStyleInterface$1.addCustomStyle(babelHelpers.assertThisInitialized(_this41));return _this41}/**
...
if(30<Math.abs(this._initScrollTop-scrollTop)||10<absDScrollTop){if(isScrollingDown&&scrollTop>=maxHeaderTop){top=maxHeaderTop}else if(!isScrollingDown&&scrollTop>=this._dHeight){top=this.condenses&&!this.fixed?this._dHeight:0}var scrollVelocity=dScrollTop/(now-this._lastTimestamp);this.style.transitionDuration=this._clamp((top-lastTop)/scrollVelocity,0,300)+"ms"}else{top=this._top}}}if(0===this._dHeight){progress=0<scrollTop?1:0}else{progress=top/this._dHeight}if(!forceUpdate){this._lastScrollTop=scrollTop;this._top=top;this._wasScrollingDown=isScrollingDown;this._lastTimestamp=now}if(forceUpdate||progress!==this._progress||lastTop!==top||0===scrollTop){this._progress=progress;this._runEffects(progress,top);this._transformHeader(top)}},/**
   ...
   */getScrollState:function getScrollState(){return{progress:this._progress,top:this._top}}});registerEffect("waterfall",{/** @this {Waterfall} */run:function run(){this.shadow=this.isOnScreen()&&this.isContentBelow()}});/**
     ...
     */var Waterfall=function Waterfall(){babelHelpers.classCallCheck(this,Waterfall);/** @type {boolean} */this.shadow};Polymer({/** @override */_template:html(_templateObject3_d65bd2a0917011eda892694d5d951519()),is:"app-toolbar"});Polymer({is:"iron-location",properties:{/**
...
// align setting is ok.
if(0>diff||0===diff&&(vAlignOk||hAlignOk)){position=candidate}}return position}};_exports.IronFitBehavior=IronFitBehavior;var ironFitBehavior={IronFitBehavior:IronFitBehavior};_exports.$ironFitBehavior=ironFitBehavior;Polymer({is:"iron-media-query",properties:{/**
...
// e.g. in Firefox `<div contenteditable>` has `tabIndex = -1`
var ati=Math.max(a.tabIndex,0),bti=Math.max(b.tabIndex,0);return 0===ati||0===bti?bti>ati:ati>bti}}]);return IronFocusablesHelperClass}(),IronFocusablesHelper=new IronFocusablesHelperClass;_exports.IronFocusablesHelper=IronFocusablesHelper;var ironFocusablesHelper={IronFocusablesHelper:IronFocusablesHelper};_exports.$ironFocusablesHelper=ironFocusablesHelper;Polymer({/** @override */_template:html(_templateObject5_d65bd2a0917011eda892694d5d951519()),is:"iron-overlay-backdrop",properties:{/**
...
document.documentElement.scrollTop=document.body.scrollTop=this.__scrollTop;document.documentElement.scrollLeft=document.body.scrollLeft=this.__scrollLeft}}};_exports.IronOverlayBehaviorImpl=IronOverlayBehaviorImpl;var composedParent=function composedParent(node){return node.assignedSlot||node.parentNode||node.host},composedContains=function composedContains(ancestor,descendant){for(var element=descendant;element;element=composedParent(element)){if(element===ancestor){return!0}}return!1},IronOverlayBehavior=[IronFitBehavior,IronResizableBehavior,IronOverlayBehaviorImpl];_exports.IronOverlayBehavior=IronOverlayBehavior;/**
                                                                                                       ...
                                                                                                       */ /**
                                                                                                           ...
                                                                                                           */ /**
                                                                                                               ...
                                                                                                               */var ironOverlayBehavior={IronOverlayBehaviorImpl:IronOverlayBehaviorImpl,IronOverlayBehavior:IronOverlayBehavior};_exports.$ironOverlayBehavior=ironOverlayBehavior;var IronSelection=/*#__PURE__*/function(){/**
...
for(var path=dom(event).path,i=0,l=path.indexOf(this),target;i<l;i++){target=path[i];if(target.hasAttribute&&(target.hasAttribute("dialog-dismiss")||target.hasAttribute("dialog-confirm"))){this._updateClosingReasonConfirmed(target.hasAttribute("dialog-confirm"));this.close();event.stopPropagation();break}}}};/** @polymerBehavior */_exports.PaperDialogBehaviorImpl=PaperDialogBehaviorImpl;var PaperDialogBehavior=[IronOverlayBehavior,PaperDialogBehaviorImpl];_exports.PaperDialogBehavior=PaperDialogBehavior;var paperDialogBehavior={PaperDialogBehaviorImpl:PaperDialogBehaviorImpl,PaperDialogBehavior:PaperDialogBehavior};_exports.$paperDialogBehavior=paperDialogBehavior;var template$1=html(_templateObject7_d65bd2a0917011eda892694d5d951519());template$1.setAttribute("style","display: none;");document.head.appendChild(template$1.content);var template$2=html(_templateObject8_d65bd2a0917011eda892694d5d951519());template$2.setAttribute("style","display: none;");document.head.appendChild(template$2.content);var template$3=html(_templateObject9_d65bd2a0917011eda892694d5d951519());template$3.setAttribute("style","display: none;");document.head.appendChild(template$3.content);var template$4=html(_templateObject10_d65bd2a0917011eda892694d5d951519());template$4.setAttribute("style","display: none;");document.head.appendChild(template$4.content);var $_documentContainer=document.createElement("template");$_documentContainer.setAttribute("style","display: none;");$_documentContainer.innerHTML="<dom-module id=\"paper-dialog-shared-styles\">\n  <template>\n    <style>\n      :host {\n        display: block;\n        margin: 24px 40px;\n\n        background: var(--paper-dialog-background-color, var(--primary-background-color));\n        color: var(--paper-dialog-color, var(--primary-text-color));\n\n        @apply --paper-font-body1;\n        @apply --shadow-elevation-16dp;\n        @apply --paper-dialog;\n      }\n\n      :host > ::slotted(*) {\n        margin-top: 20px;\n        padding: 0 24px;\n      }\n\n      :host > ::slotted(.no-padding) {\n        padding: 0;\n      }\n\n      \n      :host > ::slotted(*:first-child) {\n        margin-top: 24px;\n      }\n\n      :host > ::slotted(*:last-child) {\n        margin-bottom: 24px;\n      }\n\n      /* In 1.x, this selector was `:host > ::content h2`. In 2.x <slot> allows\n      to select direct children only, which increases the weight of this\n      selector, so we have to re-define first-child/last-child margins below. */\n      :host > ::slotted(h2) {\n        position: relative;\n        margin: 0;\n\n        @apply --paper-font-title;\n        @apply --paper-dialog-title;\n      }\n\n      /* Apply mixin again, in case it sets margin-top. */\n      :host > ::slotted(h2:first-child) {\n        margin-top: 24px;\n        @apply --paper-dialog-title;\n      }\n\n      /* Apply mixin again, in case it sets margin-bottom. */\n      :host > ::slotted(h2:last-child) {\n        margin-bottom: 24px;\n        @apply --paper-dialog-title;\n      }\n\n      :host > ::slotted(.paper-dialog-buttons),\n      :host > ::slotted(.buttons) {\n        position: relative;\n        padding: 8px 8px 8px 24px;\n        margin: 0;\n\n        color: var(--paper-dialog-button-color, var(--primary-color));\n\n        @apply --layout-horizontal;\n        @apply --layout-end-justified;\n      }\n    </style>\n  </template>\n</dom-module>";document.head.appendChild($_documentContainer.content);Polymer({_template:html(_templateObject11_d65bd2a0917011eda892694d5d951519()),is:"paper-dialog",behaviors:[PaperDialogBehavior,NeonAnimationRunnerBehavior],listeners:{"neon-animation-finish":"_onNeonAnimationFinish"},_renderOpened:function _renderOpened(){this.cancelAnimation();this.playAnimation("entry")},_renderClosed:function _renderClosed(){this.cancelAnimation();this.playAnimation("exit")},_onNeonAnimationFinish:function _onNeonAnimationFinish(){if(this.opened){this._finishRenderOpened()}else{this._finishRenderClosed()}}});var categoryList=[{name:"mens_outerwear",title:"Men's Outerwear",image:"images/mens_outerwear.jpg",placeholder:"data:image/jpeg;base64,"},{name:"ladies_outerwear",title:"Ladies Outerwear",image:"images/ladies_outerwear.jpg",placeholder:"data:image/jpeg;base64,"},{name:"mens_tshirts",title:"Men's T-Shirts",image:"images/mens_tshirts.jpg",placeholder:"data:image/jpeg;base64,"},{name:"ladies_tshirts",title:"Ladies T-Shirts",image:"images/ladies_tshirts.jpg",placeholder:"data:image/jpeg;base64,"}],ShopCategoryData=/*#__PURE__*/function(_PolymerElement2){babelHelpers.inherits(ShopCategoryData,_PolymerElement2);function ShopCategoryData(){babelHelpers.classCallCheck(this,ShopCategoryData);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ShopCategoryData).apply(this,arguments))}babelHelpers.createClass(ShopCategoryData,[{key:"_getCategoryObject",value:function _getCategoryObject(categoryName){for(var _i84=0,c;c=this.categories[_i84];++_i84){if(c.name===categoryName){return c}}}},{key:"_computeCategory",value:function _computeCategory(categoryName){// Fetch the items of the category. Note that the fetch is asynchronous,
// which means `category.items` may not be set initially (but that path
// will be notified when the fetch completes).
var categoryObj=this._getCategoryObject(categoryName);this._fetchItems(categoryObj,1);return categoryObj}},{key:"_computeItem",value:function _computeItem(items,itemName){if(!items||!itemName){return}for(var _i85=0,item;item=items[_i85];++_i85){if(item.name===itemName){return item}}}},{key:"_fetchItems",value:function _fetchItems(category,attempts){this._setFailure(!1);// Only fetch the items of a category if it has not been previously set.
if(!category||category.items){return}this._getResource({url:"data/"+category.name+".json",onLoad:function onLoad(e){this.set("category.items",JSON.parse(e.target.responseText))},onError:function onError(e){this._setFailure(!0)}},attempts)}},{key:"_getResource",value:function _getResource(rq,attempts){var _this42=this,xhr=new XMLHttpRequest;xhr.addEventListener("load",rq.onLoad.bind(this));xhr.addEventListener("error",function(e){// Flaky connections might fail fetching resources
if(1<attempts){_this42._getResourceDebouncer=Debouncer.debounce(_this42._getResourceDebouncer,timeOut.after(200),_this42._getResource.bind(_this42,rq,attempts-1))}else{rq.onError.call(_this42,e)}});xhr.open("GET",rq.url);xhr.send()}},{key:"refresh",value:function refresh(){if(this.categoryName){// Try at most 3 times to get the items.
this._fetchItems(this._getCategoryObject(this.categoryName),3)}}}],[{key:"is",get:function get(){return"shop-category-data"}},{key:"properties",get:function get(){return{categoryName:String,itemName:String,categories:{type:Array,value:categoryList,readOnly:!0,notify:!0},category:{type:Object,computed:"_computeCategory(categoryName)",notify:!0},item:{type:Object,computed:"_computeItem(category.items, itemName)",notify:!0},failure:{type:Boolean,notify:!0,readOnly:!0}}}}]);return ShopCategoryData}(PolymerElement);customElements.define(ShopCategoryData.is,ShopCategoryData);var $_documentContainer$1=document.createElement("template");$_documentContainer$1.innerHTML="<dom-module id=\"shop-common-styles\">\n  <template>\n    <style>\n\n      [hidden] {\n        display: none !important;\n      }\n\n      header {\n        text-align: center;\n      }\n\n      header > h1 {\n        margin: 0 0 4px 0;\n        font-size: 1.3em;\n        font-weight: 500;\n      }\n\n      header > span {\n        color: var(--app-secondary-color);\n        font-size: 12px;\n      }\n\n      header > shop-button[responsive] {\n        margin-top: 20px;\n      }\n\n      @media (max-width: 767px) {\n\n        header > h1 {\n          font-size: 1.1em;\n        }\n\n      }\n\n    </style>\n  </template>\n</dom-module>";document.head.appendChild($_documentContainer$1.content);var shippingOptions=[{id:"free",label:"Free shipping",description:"Arrives in 5 to 7 days",price:0},{id:"express",label:"Express shipping",description:"$5.00 - Arrives in 1 to 3 days",price:5}],paymentRequest={apiVersion:2,apiVersionMinor:0,allowedPaymentMethods:[{type:"CARD",parameters:{allowedAuthMethods:["PAN_ONLY","CRYPTOGRAM_3DS"],allowedCardNetworks:["MASTERCARD","VISA"]},tokenizationSpecification:{type:"PAYMENT_GATEWAY",parameters:{gateway:"example",gatewayId:"1234567890"}}}],merchantInfo:{merchantId:"17613812255336763067",merchantName:"Gezmo,Inc."},transactionInfo:{totalPriceStatus:"FINAL",totalPriceLabel:"Total",totalPrice:"0",currencyCode:"USD",countryCode:"US"},callbackIntents:["PAYMENT_AUTHORIZATION","SHIPPING_OPTION"],shippingAddressRequired:!0,shippingOptionRequired:!0,shippingOptionParameters:{defaultSelectedOptionId:shippingOptions[0].id,shippingOptions:shippingOptions.map(function(o){return{id:o.id,label:o.label,description:o.description}})}};function buildGooglePayPaymentRequest(displayItems,shippingOption){var opt=shippingOption||shippingOptions[0],items=[].concat(babelHelpers.toConsumableArray(displayItems),[{label:opt.label,price:opt.price.toFixed(2),type:"SHIPPING_OPTION"}]);return _objectSpread({},paymentRequest,{transactionInfo:{totalPriceStatus:"FINAL",totalPriceLabel:"Total",currencyCode:"USD",countryCode:"US",displayItems:items,totalPrice:items.reduce(function(total,item){return total+ +item.price},0).toFixed(2)}})}var config={googlepay:{environment:"TEST",existingPaymentMethodRequired:!1,appearance:{buttonColor:"default",buttonType:"long"},paymentRequest:paymentRequest,shippingOptions:shippingOptions,onLoadPaymentData:function onLoadPaymentData(paymentResponse,context){console.log("Success",paymentResponse);this.dispatchEvent(new CustomEvent("payment-selected",{bubbles:!0,composed:!0,detail:{paymentResponse:paymentResponse,context:"function"===typeof context?context():context}}))},onPaymentAuthorized:function onPaymentAuthorized(){return{transactionState:"SUCCESS"}},buildPaymentRequest:buildGooglePayPaymentRequest}};function getGooglePayConfig(){return _objectSpread({},config.googlepay)}var shopConfiguration={getGooglePayConfig:getGooglePayConfig};_exports.$shopConfiguration=shopConfiguration;function filterPaymentRequest(paymentRequest){var callbackIntents=paymentRequest.callbackIntents,request=babelHelpers.objectWithoutProperties(paymentRequest,["callbackIntents"]);return request}var googlepayConfig=getGooglePayConfig(),defaultPaymentRequest=filterPaymentRequest(googlepayConfig.paymentRequest),ShopDeveloper=/*#__PURE__*/function(_PolymerElement3){babelHelpers.inherits(ShopDeveloper,_PolymerElement3);babelHelpers.createClass(ShopDeveloper,null,[{key:"template",get:function get(){return html(_templateObject12_d65bd2a0917011eda892694d5d951519())}}]);function ShopDeveloper(){var _this43;babelHelpers.classCallCheck(this,ShopDeveloper);_this43=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ShopDeveloper).call(this));_this43._handleEditorChanged=_this43._handleEditorChanged.bind(babelHelpers.assertThisInitialized(_this43));_this43._onGooglePayPaymentDataResult=_this43._onGooglePayPaymentDataResult.bind(babelHelpers.assertThisInitialized(_this43));_this43._onGooglePayError=_this43._onGooglePayError.bind(babelHelpers.assertThisInitialized(_this43));_this43._onGooglePayCancel=_this43._onGooglePayCancel.bind(babelHelpers.assertThisInitialized(_this43));return _this43}babelHelpers.createClass(ShopDeveloper,[{key:"connectedCallback",value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(ShopDeveloper.prototype),"connectedCallback",this).call(this);this.$.aceWidget.addEventListener("blur",this._handleEditorChanged)}},{key:"disconnectedCallback",value:function disconnectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(ShopDeveloper.prototype),"disconnectedCallback",this).call(this);this.$.aceWidget.removeEventListener("blur",this._handleEditorChanged)}},{key:"_handleEditorChanged",value:function _handleEditorChanged(){var paymentRequest=this.getEditorValue();this.$.googlePayButton.paymentRequest=paymentRequest}},{key:"open",value:function open(){var value=this.$.aceWidget.value;if(!value){this.setEditorValue(defaultPaymentRequest)}this.$.dialog.open()}},{key:"getEditorValue",value:function getEditorValue(){try{return JSON.parse(this.$.aceWidget.value)}catch(err){return void 0}}},{key:"setEditorValue",value:function setEditorValue(obj){this._paymentRequest=filterPaymentRequest(obj);this.$.aceWidget.value=JSON.stringify(this._paymentRequest,null,"  ");this.$.dialog.refit()}},{key:"setResponseValue",value:function setResponseValue(obj){this.$.aceWidgetResponse.value=JSON.stringify(obj,null,"  ");this.$.dialog.refit()}},{key:"_onGooglePayPaymentDataResult",value:function _onGooglePayPaymentDataResult(paymentResponse){this.setResponseValue(paymentResponse)}},{key:"_onGooglePayError",value:function _onGooglePayError(error){this.setResponseValue(error)}},{key:"_onGooglePayCancel",value:function _onGooglePayCancel(reason){this.setResponseValue(reason)}},{key:"paymentRequest",get:function get(){return this._paymentRequest||defaultPaymentRequest}}],[{key:"is",get:function get(){return"shop-developer"}},{key:"properties",get:function get(){return{googlepayConfig:{type:Object,value:function value(){return googlepayConfig}}}}}]);return ShopDeveloper}(PolymerElement);customElements.define(ShopDeveloper.is,ShopDeveloper);var $_documentContainer$2=document.createElement("template");$_documentContainer$2.innerHTML="<dom-module id=\"shop-button\">\n  <template>\n    <style>\n\n      shop-button {\n        display: inline-block;\n      }\n\n      shop-button > * {\n        display: inline-block;\n        box-sizing: border-box;\n        border: 2px solid #000;\n        background-color: #FFF;\n        font-size: 14px;\n        font-weight: 500;\n        color: var(--app-primary-color);\n        margin: 0;\n        padding: 8px 44px;\n        text-align: center;\n        text-decoration: none;\n        text-transform: uppercase;\n        border-radius: 0;\n        outline: none;\n        -webkit-appearance: none;\n        width: 100%;\n        line-height: normal;\n      }\n\n      shop-button > *:focus {\n        background-color: #c5cad3;\n      }\n\n      shop-button > *:active {\n        background-color: #000;\n        color: #FFF;\n      }\n\n      @media (max-width: 767px) {\n\n        /* Responsive buttons are used in shop-detail, shop-cart and shop-checkout */\n        shop-button[responsive] {\n          @apply --layout-fixed-bottom;\n          height: 64px;\n          z-index: 1;\n        }\n\n        shop-button[responsive] > * {\n          background-color: var(--app-accent-color);\n          border: none;\n          color: white;\n          padding: 20px;\n          width: 100%;\n          height: 100%;\n          font-size: 15px;\n        }\n\n        shop-button[responsive] > *:focus {\n          background-color: var(--app-accent-color);\n        }\n\n      }\n\n    </style>\n  </template>\n</dom-module>";document.head.appendChild($_documentContainer$2.content);var ShopImage=/*#__PURE__*/function(_PolymerElement4){babelHelpers.inherits(ShopImage,_PolymerElement4);function ShopImage(){babelHelpers.classCallCheck(this,ShopImage);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ShopImage).apply(this,arguments))}babelHelpers.createClass(ShopImage,[{key:"_srcChanged",value:function _srcChanged(src){this.$.img.removeAttribute("src");this.$.img.style.transition="";this.$.img.style.opacity=0;if(src){this.$.img.src=src}}},{key:"_onImgLoad",value:function _onImgLoad(){this.$.img.style.transition="0.5s opacity";this.$.img.style.opacity=1}},{key:"_onImgError",value:function _onImgError(){if(!this.placeholderImg){this.$.img.src="data:image/svg+xml,"+encodeURIComponent("<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><path fill=\"#CCC\" d=\"M21 19V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2zM8.5 13.5l2.5 3.01L14.5 12l4.5 6H5l3.5-4.5z\"/></svg>")}}},{key:"_placeholderImgChanged",value:function _placeholderImgChanged(placeholder){this.style.backgroundImage="url('"+placeholder+"')"}}],[{key:"template",get:function get(){return html(_templateObject13_d65bd2a0917011eda892694d5d951519())}},{key:"is",get:function get(){return"shop-image"}},{key:"properties",get:function get(){return{alt:String,src:{type:String,observer:"_srcChanged"},placeholderImg:{type:String,observer:"_placeholderImgChanged"}}}}]);return ShopImage}(PolymerElement);customElements.define(ShopImage.is,ShopImage);var ShopHome=/*#__PURE__*/function(_PolymerElement5){babelHelpers.inherits(ShopHome,_PolymerElement5);function ShopHome(){babelHelpers.classCallCheck(this,ShopHome);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ShopHome).apply(this,arguments))}babelHelpers.createClass(ShopHome,[{key:"_visibleChanged",value:function _visibleChanged(visible){if(visible){this.dispatchEvent(new CustomEvent("change-section",{bubbles:!0,composed:!0,detail:{title:"Home"}}))}}}],[{key:"template",get:function get(){return html(_templateObject14_d65bd2a0917011eda892694d5d951519())}},{key:"is",get:function get(){return"shop-home"}},{key:"properties",get:function get(){return{categories:{type:Array},visible:{type:Boolean,observer:"_visibleChanged"}}}}]);return ShopHome}(PolymerElement);customElements.define(ShopHome.is,ShopHome);window.performance&&performance.mark&&performance.mark("shop-app - before register");var googlepayConfig$1=getGooglePayConfig(),ShopApp=/*#__PURE__*/function(_PolymerElement6){babelHelpers.inherits(ShopApp,_PolymerElement6);babelHelpers.createClass(ShopApp,null,[{key:"template",get:function get(){return html(_templateObject15_d65bd2a0917011eda892694d5d951519())}},{key:"is",get:function get(){return"shop-app"}},{key:"properties",get:function get(){return{page:{type:String,reflectToAttribute:!0,observer:"_pageChanged"},numItems:{type:Number,value:0},_shouldShowTabs:{computed:"_computeShouldShowTabs(page, smallScreen)"},_shouldRenderTabs:{computed:"_computeShouldRenderTabs(_shouldShowTabs, loadComplete)"},_shouldRenderDrawer:{computed:"_computeShouldRenderDrawer(smallScreen, loadComplete)"}}}},{key:"observers",get:function get(){return["_routePageChanged(routeData.page)"]}}]);function ShopApp(){var _this44;babelHelpers.classCallCheck(this,ShopApp);_this44=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ShopApp).call(this));window.performance&&performance.mark&&performance.mark("shop-app.created");return _this44}babelHelpers.createClass(ShopApp,[{key:"ready",value:function ready(){var _this45=this;babelHelpers.get(babelHelpers.getPrototypeOf(ShopApp.prototype),"ready",this).call(this);// Custom elements polyfill safe way to indicate an element has been upgraded.
this.removeAttribute("unresolved");// listen for custom events
this.addEventListener("add-cart-item",function(e){return _this45._onAddCartItem(e)});this.addEventListener("set-cart-item",function(e){return _this45._onSetCartItem(e)});this.addEventListener("clear-cart",function(e){return _this45._onClearCart(e)});this.addEventListener("change-section",function(e){return _this45._onChangeSection(e)});this.addEventListener("announce",function(e){return _this45._onAnnounce(e)});this.addEventListener("dom-change",function(e){return _this45._domChange(e)});this.addEventListener("show-invalid-url-warning",function(e){return _this45._onFallbackSelectionTriggered(e)});this.addEventListener("payment-selected",function(e){return _this45._onPaymentSelected(e)});this.addEventListener("confirmation",function(e){return _this45._onConfirmation(e)});// listen for online/offline
afterNextRender(this,function(){window.addEventListener("online",function(e){return _this45._notifyNetworkStatus(e)});window.addEventListener("offline",function(e){return _this45._notifyNetworkStatus(e)})})}},{key:"_routePageChanged",value:function _routePageChanged(page){if("list"===this.page){this._listScrollTop=window.pageYOffset}this.page=page||"home";// Close the drawer - in case the *route* change came from a link in the drawer.
this.drawerOpened=!1}},{key:"_pageChanged",value:function _pageChanged(page,oldPage){if(null!=page){var cb=this._pageLoaded.bind(this,!!oldPage);switch(page){case"list":new Promise(function(res,rej){return _require.default(["./shop-list.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$shopList||{}}).then(cb);break;case"detail":new Promise(function(res,rej){return _require.default(["./shop-detail.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$shopDetail||{}}).then(cb);break;case"cart":new Promise(function(res,rej){return _require.default(["./shop-cart.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$shopCart||{}}).then(cb);break;case"checkout":new Promise(function(res,rej){return _require.default(["./shop-checkout.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$shopCheckout||{}}).then(cb);break;case"confirmation":new Promise(function(res,rej){return _require.default(["./shop-confirmation.js"],res,rej)}).then(function(bundle){return bundle&&bundle.$shopConfirmation||{}}).then(cb);break;default:this._pageLoaded(!!oldPage);}}}},{key:"_pageLoaded",value:function _pageLoaded(shouldResetLayout){var _this46=this;this._ensureLazyLoaded();if(shouldResetLayout){// The size of the header depends on the page (e.g. on some pages the tabs
// do not appear), so reset the header's layout only when switching pages.
timeOut.run(function(){_this46.$.header.resetLayout()},1)}}},{key:"_ensureLazyLoaded",value:function _ensureLazyLoaded(){var _this47=this;// load lazy resources after render and set `loadComplete` when done.
...
this._setMeta("property","twitter:title",detail.title);this._setMeta("property","twitter:description",detail.description||document.title);this._setMeta("property","twitter:url",document.location.href);this._setMeta("property","twitter:image:src",detail.image||this.baseURI+"images/shop-icon-128.png")}}},{key:"_onAddCartItem",value:function _onAddCartItem(event){if(!this._cartModal){this._cartModal=document.createElement("shop-cart-modal");this.root.appendChild(this._cartModal)}this.$.cart.addItem(event.detail);this._cartModal.open();this._announce("Item added to the cart")}},{key:"_onSetCartItem",value:function _onSetCartItem(event){var detail=event.detail;this.$.cart.setItem(detail);if(0===detail.quantity){this._announce("Item deleted")}else{this._announce("Quantity changed to "+detail.quantity)}}},{key:"_onPaymentSelected",value:function _onPaymentSelected(event){var _event$detail=event.detail,paymentResponse=_event$detail.paymentResponse,context=_event$detail.context;if("google-pay"===context.method){this._processGooglePayPayment(paymentResponse,context)}if("cart"===context.type){this.dispatchEvent(new CustomEvent("clear-cart",{bubbles:!0,composed:!0}))}this.dispatchEvent(new CustomEvent("confirmation",{bubbles:!0,composed:!0}))}},{key:"_onConfirmation",value:function _onConfirmation(event){this.set("route.path","/confirmation")}},{key:"_processGooglePayPayment",value:function _processGooglePayPayment(paymentResponse,context){console.log("Process Google Pay Payment",paymentResponse,context)}},{key:"_onClearCart",value:function _onClearCart(){this.$.cart.clearCart();this._announce("Cart cleared")}// Elements in the app can notify a change to be a11y announced.
},{key:"_onAnnounce",value:function _onAnnounce(e){this._announce(e.detail)}// A11y announce the given message.
},{key:"_announce",value:function _announce(message){var _this48=this;this._a11yLabel="";this._announceDebouncer=Debouncer.debounce(this._announceDebouncer,timeOut.after(100),function(){_this48._a11yLabel=message})}// This is for performance logging only.
},{key:"_domChange",value:function _domChange(e){if(window.performance&&performance.mark&&!this.__loggedDomChange){var target=e.composedPath()[0],host=target.getRootNode().host;if(host&&host.localName.match(this.page)){this.__loggedDomChange=!0;performance.mark(host.localName+".domChange")}}}},{key:"_onFallbackSelectionTriggered",value:function _onFallbackSelectionTriggered(){this.page="404"}},{key:"_computeShouldShowTabs",value:function _computeShouldShowTabs(page,smallScreen){return("home"===page||"list"===page||"detail"===page)&&!smallScreen}},{key:"_computeShouldRenderTabs",value:function _computeShouldRenderTabs(_shouldShowTabs,loadComplete){return _shouldShowTabs&&loadComplete}},{key:"_computeShouldRenderDrawer",value:function _computeShouldRenderDrawer(smallScreen,loadComplete){return smallScreen&&loadComplete}},{key:"_computePluralizedQuantity",value:function _computePluralizedQuantity(quantity){return quantity+" "+(1===quantity?"item":"items")}},{key:"_openDeveloperDialog",value:function _openDeveloperDialog(){var paymentRequest=this._getGooglePayTransactionInfo();this.$.developerDialog.setEditorValue(paymentRequest);this.$.developerDialog.open()}},{key:"_getGooglePayTransactionInfo",value:function _getGooglePayTransactionInfo(){if(this.cart){var _paymentRequest=googlepayConfig$1.buildPaymentRequest(this.cart.map(function(i){return{label:"".concat(i.item.title," x ").concat(i.quantity),type:"LINE_ITEM",price:(i.item.price*i.quantity).toFixed(2)}}));return _paymentRequest}return null}}]);return ShopApp}(PolymerElement);customElements.define(ShopApp.is,ShopApp);var ShopDisclaimer=/*#__PURE__*/function(_PolymerElement7){babelHelpers.inherits(ShopDisclaimer,_PolymerElement7);function ShopDisclaimer(){babelHelpers.classCallCheck(this,ShopDisclaimer);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ShopDisclaimer).apply(this,arguments))}babelHelpers.createClass(ShopDisclaimer,null,[{key:"template",get:function get(){return html(_templateObject16_d65bd2a0917011eda892694d5d951519())}},{key:"is",get:function get(){return"shop-disclaimer"}}]);return ShopDisclaimer}(PolymerElement);customElements.define(ShopDisclaimer.is,ShopDisclaimer);var $_documentContainer$3=document.createElement("template");$_documentContainer$3.innerHTML="<dom-module id=\"shop-form-styles\">\n  <template>\n    <style>\n\n      :host {\n        display: block;\n      }\n\n      .main-frame {\n        margin: 0 auto;\n        padding: 0 24px 48px 24px;\n        max-width: 900px;\n        overflow: hidden;\n      }\n\n      .subsection:not([visible]) {\n        display: none;\n      }\n\n      .empty-cart {\n        text-align: center;\n        white-space: nowrap;\n        color: var(--app-secondary-color);\n      }\n\n      h2 {\n        font-size: 13px;\n      }\n\n    </style>\n  </template>\n</dom-module>";document.head.appendChild($_documentContainer$3.content);var $_documentContainer$4=document.createElement("template");$_documentContainer$4.innerHTML="<dom-module id=\"shop-select\">\n  <template>\n    <style>\n\n      shop-select {\n        display: inline-block;\n        position: relative;\n        /* create a layer to avoid invalidation from other controls*/\n        -webkit-transform: translateZ(0);\n        transform: translateZ(0);\n      }\n\n      shop-select > shop-md-decorator {\n        display: block;\n        border-top: 1px solid #ccc;\n        height: 1px;\n        speak: none;\n      }\n\n      shop-select > shop-md-decorator::after {\n        content: '\\25BC';\n        display: block;\n        position: absolute;\n        bottom: calc(50% - 0.75em);\n        right: 8px;\n        speak: none;\n        -webkit-transform: scaleY(.6);\n        transform: scaleY(.6);\n        color: var(--app-secondary-color);\n        pointer-events: none;\n      }\n\n      shop-select > select {\n        width: 100%;\n        -webkit-appearance: none;\n        -moz-appearance: none;\n        appearance: none;\n        padding: 8px 24px 8px 0;\n        border: none;\n        background-color: transparent;\n        border-radius: 0;\n        font-size: 1em;\n        font-weight: 300;\n        color: var(--app-primary-color);\n        overflow: hidden;\n        margin: 0;\n        outline: none;\n      }\n\n      shop-select > select::-ms-expand {\n        display: none;\n      }\n\n      shop-select > shop-md-decorator > shop-underline {\n        display: block;\n        background-color: var(--app-accent-color);\n        height: 2px;\n        position: relative;\n        top: -1px;\n        width: 100%;\n        margin: auto;\n        -webkit-transform: scale3d(0, 1, 1);\n        transform: scale3d(0, 1, 1);\n        transition: -webkit-transform 0.2s ease-in;\n        transition: transform 0.2s ease-in;\n      }\n\n      shop-select > select:focus + shop-md-decorator > shop-underline {\n        -webkit-transform: scale3d(1, 1, 1);\n        transform: scale3d(1, 1, 1);\n        transition: -webkit-transform 0.2s ease-out;\n        transition: transform 0.2s ease-out;\n      }\n\n      shop-select > select:focus + shop-md-decorator::before,\n      shop-select > select:focus + shop-md-decorator::after,\n      shop-select > select:focus {\n        color: black;\n      }\n\n      /* hide the focus ring in firefox */\n      shop-select > select:focus:-moz-focusring {\n        color: transparent;\n        text-shadow: 0 0 0 #000;\n      }\n\n      shop-select > [prefix] {\n        position: absolute;\n        left: 0px;\n        top: calc(50% - 8px);\n        line-height: 16px;\n        color: var(--app-secondary-color);\n        pointer-events: none;\n      }\n\n    </style>\n  </template>\n</dom-module>";document.head.appendChild($_documentContainer$4.content)});